...
from ...models.create_quizzes_data_body import CreateQuizzesDataBody
from ...models.create_quizzes_json_body import CreateQuizzesJsonBody
from ...models.create_quizzes_response_200 import CreateQuizzesResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    if isinstance(body, CreateQuizzesJsonBody):
        _kwargs["json"] = body.to_dict()

        headers["Content-Type"] = "application/json"
    if isinstance(body, CreateQuizzesDataBody):
...
) -> Optional[Union[Any, CreateQuizzesResponse200]]:
    if response.status_code == 200:
        response_200 = CreateQuizzesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, CreateQuizzesResponse200]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (CreateQuizzesJsonBody):
        body (CreateQuizzesDataBody):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, CreateQuizzesResponse200]
    """
