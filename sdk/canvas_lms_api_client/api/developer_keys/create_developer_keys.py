...
from ...models.create_developer_keys_data_body import CreateDeveloperKeysDataBody
from ...models.create_developer_keys_json_body import CreateDeveloperKeysJsonBody
from ...models.create_developer_keys_response_200_item import CreateDeveloperKeysResponse200Item
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/api/v1/accounts/{account_id}/developer_keys",
        "params": params,
    }

    if isinstance(body, CreateDeveloperKeysJsonBody):
        _kwargs["json"] = body.to_dict()

        headers["Content-Type"] = "application/json"
    if isinstance(body, CreateDeveloperKeysDataBody):
...
) -> Optional[Union[Any, list["CreateDeveloperKeysResponse200Item"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = CreateDeveloperKeysResponse200Item.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, list["CreateDeveloperKeysResponse200Item"]]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Post Accounts Developer_Keys

     Create a new Canvas API key. Creating an LTI 1.3 registration is not supported here and should be
    ...
    Args:
        ...
        body (CreateDeveloperKeysJsonBody):
        body (CreateDeveloperKeysDataBody):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, list['CreateDeveloperKeysResponse200Item']]
    """
