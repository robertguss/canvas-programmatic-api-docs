...
from ...models.create_originality_report_data_body import CreateOriginalityReportDataBody
from ...models.create_originality_report_json_body import CreateOriginalityReportJsonBody
from ...models.create_originality_report_response_200 import CreateOriginalityReportResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    originality_reportattempt: int,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    params: dict[str, Any] = {}

    params["originality_report[file_id]"] = originality_reportfile_id
    ...
    params["originality_report[attempt]"] = originality_reportattempt

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/api/lti/assignments/{assignment_id}/submissions/{submission_id}/originality_report",
        "params": params,
    }

    if isinstance(body, CreateOriginalityReportJsonBody):
        _kwargs["json"] = body.to_dict()

        headers["Content-Type"] = "application/json"
    if isinstance(body, CreateOriginalityReportDataBody):
...
) -> Optional[Union[Any, CreateOriginalityReportResponse200]]:
    if response.status_code == 200:
        response_200 = CreateOriginalityReportResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, CreateOriginalityReportResponse200]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Post Assignments Originality_Report
    ...
    Args:
        ...
        originality_reportattempt (int):
        body (CreateOriginalityReportJsonBody):
        body (CreateOriginalityReportDataBody):
    ...
    kwargs = _get_kwargs(
        ...
        body=body,
        originality_reportfile_id=originality_reportfile_id,
        ...
        originality_reportattempt=originality_reportattempt,
    )
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, CreateOriginalityReportResponse200]
    """
