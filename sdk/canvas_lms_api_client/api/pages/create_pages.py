...
from ...models.create_pages_data_body import CreatePagesDataBody
from ...models.create_pages_json_body import CreatePagesJsonBody
from ...models.create_pages_response_200 import CreatePagesResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/api/v1/groups/{group_id}/pages",
        "params": params,
    }

    if isinstance(body, CreatePagesJsonBody):
        _kwargs["json"] = body.to_dict()

        headers["Content-Type"] = "application/json"
    if isinstance(body, CreatePagesDataBody):
...
) -> Optional[Union[Any, CreatePagesResponse200]]:
    if response.status_code == 200:
        response_200 = CreatePagesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, CreatePagesResponse200]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (CreatePagesJsonBody):
        body (CreatePagesDataBody):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, CreatePagesResponse200]
    """
