...
from ...models.create_rubrics_data_body import CreateRubricsDataBody
from ...models.create_rubrics_json_body import CreateRubricsJsonBody
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/api/v1/courses/{course_id}/rubrics",
        "params": params,
    }

    if isinstance(body, CreateRubricsJsonBody):
        _kwargs["json"] = body.to_dict()

        headers["Content-Type"] = "application/json"
    if isinstance(body, CreateRubricsDataBody):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (CreateRubricsJsonBody):
        body (CreateRubricsDataBody):
