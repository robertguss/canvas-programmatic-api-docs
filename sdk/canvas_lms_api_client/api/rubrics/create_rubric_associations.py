...
from ...models.create_rubric_associations_response_200 import CreateRubricAssociationsResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/api/v1/courses/{course_id}/rubric_associations",
        "params": params,
    }
...
) -> Optional[Union[Any, CreateRubricAssociationsResponse200]]:
    if response.status_code == 200:
        response_200 = CreateRubricAssociationsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, CreateRubricAssociationsResponse200]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Post Courses Rubric_Associations
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, CreateRubricAssociationsResponse200]
    """
