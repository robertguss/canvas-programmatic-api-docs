...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/api/v1/groups/{group_id}/discussion_topics/{topic_id}/read_all",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Delete Groups Read_All

     Mark the discussion topic and all its entries as unread. No request fields are necessary. On
