...
from ...models.get_items_response_200_item import GetItemsResponse200Item
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/quiz/v1/courses/{course_id_path}/quizzes/{assignment_id_path}/items",
        "params": params,
    }
...
) -> Optional[Union[Any, list["GetItemsResponse200Item"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = GetItemsResponse200Item.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, list["GetItemsResponse200Item"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, list['GetItemsResponse200Item']]
    """
