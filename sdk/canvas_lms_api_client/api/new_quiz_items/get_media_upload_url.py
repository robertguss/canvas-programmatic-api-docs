...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/quiz/v1/courses/{course_id_path}/quizzes/{assignment_id_path}/items/media_upload_url",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get V1 Media_Upload_Url

     Get a url for uploading media for use in hot-spot question types. See the hot-spot question type in
    the [Appendix: Question Types](#Question+Types-appendix) for more details about using this endpoint.
