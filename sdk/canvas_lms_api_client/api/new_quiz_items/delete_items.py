...
from ...models.delete_items_response_200 import DeleteItemsResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    item_id_query: Union[Unset, str] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    params["item_id"] = item_id_query

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/api/quiz/v1/courses/{course_id_path}/quizzes/{assignment_id_path}/items/{item_id_path}",
        "params": params,
    }
...
) -> Optional[Union[Any, DeleteItemsResponse200]]:
    if response.status_code == 200:
        response_200 = DeleteItemsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, DeleteItemsResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, DeleteItemsResponse200]
    """
