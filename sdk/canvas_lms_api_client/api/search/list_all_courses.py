...
def _get_kwargs(
    *,
    ...
    public_only: Union[Unset, bool] = UNSET,
    open_enrollment_only: Union[Unset, bool] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        public_only (Union[Unset, bool]):
        open_enrollment_only (Union[Unset, bool]):
