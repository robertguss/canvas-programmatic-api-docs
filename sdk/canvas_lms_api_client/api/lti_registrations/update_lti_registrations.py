...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/api/v1/accounts/{account_id}/lti_registrations/{id}",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Put Accounts Lti_Registrations

     Update the specified LTI registration with the provided parameters. Note that updating the base tool
    configuration of a registration that is associated with a Dynamic Registration will return a 422.
