...
from ...models.create_questions_data_body import CreateQuestionsDataBody
from ...models.create_questions_json_body import CreateQuestionsJsonBody
from ...models.create_questions_response_200 import CreateQuestionsResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/api/v1/courses/{course_id}/quizzes/{quiz_id}/questions",
        "params": params,
    }

    if isinstance(body, CreateQuestionsJsonBody):
        _kwargs["json"] = body.to_dict()

        headers["Content-Type"] = "application/json"
    if isinstance(body, CreateQuestionsDataBody):
...
) -> Optional[Union[Any, CreateQuestionsResponse200]]:
    if response.status_code == 200:
        response_200 = CreateQuestionsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, CreateQuestionsResponse200]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (CreateQuestionsJsonBody):
        body (CreateQuestionsDataBody):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, CreateQuestionsResponse200]
    """
