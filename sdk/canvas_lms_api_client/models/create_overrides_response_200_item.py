...
T = TypeVar("T", bound="CreateOverridesResponse200Item")


@_attrs_define
class CreateOverridesResponse200Item:
    """
    Attributes:
        id (int):
        assignment_id (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_overrides_response_200_item = cls(
            id=id,
            assignment_id=assignment_id,
            quiz_id=quiz_id,
            context_module_id=context_module_id,
        ...
        create_overrides_response_200_item.additional_properties = d
        return create_overrides_response_200_item
