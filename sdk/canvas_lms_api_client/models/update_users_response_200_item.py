...
T = TypeVar("T", bound="UpdateUsersResponse200Item")


@_attrs_define
class UpdateUsersResponse200Item:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_users_response_200_item = cls(
            id=id,
            name=name,
            sortable_name=sortable_name,
            last_name=last_name,
        ...
        update_users_response_200_item.additional_properties = d
        return update_users_response_200_item
