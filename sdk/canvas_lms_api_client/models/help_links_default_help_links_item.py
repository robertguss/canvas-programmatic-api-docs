...
T = TypeVar("T", bound="HelpLinksDefaultHelpLinksItem")


@_attrs_define
class HelpLinksDefaultHelpLinksItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        help_links_default_help_links_item = cls(
            available_to=available_to,
            text=text,
            subtext=subtext,
            url=url,
        ...
        help_links_default_help_links_item.additional_properties = d
        return help_links_default_help_links_item
