...
T = TypeVar("T", bound="GetFileRefResponse200")


@_attrs_define
class GetFileRefResponse200:
    """
    Attributes:
        id (int):
        uuid (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_file_ref_response_200.additional_properties = d
        return get_file_ref_response_200
