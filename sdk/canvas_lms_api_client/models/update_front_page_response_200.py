...
if TYPE_CHECKING:
    from ..models.update_front_page_response_200_block_editor_attributes import (
        UpdateFrontPageResponse200BlockEditorAttributes,
    )


T = TypeVar("T", bound="UpdateFrontPageResponse200")


@_attrs_define
class UpdateFrontPageResponse200:
    """
    Attributes:
        page_id (int):
        url (str):
        ...
        editor (str):
        block_editor_attributes (UpdateFrontPageResponse200BlockEditorAttributes):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        block_editor_attributes = UpdateFrontPageResponse200BlockEditorAttributes.from_dict(
            d.pop("block_editor_attributes")
        )

        update_front_page_response_200 = cls(
            page_id=page_id,
            url=url,
            title=title,
            created_at=created_at,
        ...
        update_front_page_response_200.additional_properties = d
        return update_front_page_response_200
