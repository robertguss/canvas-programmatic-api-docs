...
T = TypeVar("T", bound="UpdateUsageRightsDataBody")


@_attrs_define
class UpdateUsageRightsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_usage_rights_data_body = cls(
            file_ids=file_ids,
            usage_rightsuse_justification=usage_rightsuse_justification,
        )

        update_usage_rights_data_body.additional_properties = d
        return update_usage_rights_data_body
