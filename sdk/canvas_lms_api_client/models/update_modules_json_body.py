...
T = TypeVar("T", bound="UpdateModulesJsonBody")


@_attrs_define
class UpdateModulesJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_modules_json_body = cls(
            moduleunlock_at=moduleunlock_at,
        )

        update_modules_json_body.additional_properties = d
        return update_modules_json_body
