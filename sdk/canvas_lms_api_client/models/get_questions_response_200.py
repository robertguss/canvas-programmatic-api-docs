...
T = TypeVar("T", bound="GetQuestionsResponse200")


@_attrs_define
class GetQuestionsResponse200:
    """
    Attributes:
        id (int):
        quiz_id (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_questions_response_200 = cls(
            id=id,
            quiz_id=quiz_id,
            position=position,
            question_name=question_name,
        ...
        get_questions_response_200.additional_properties = d
        return get_questions_response_200
