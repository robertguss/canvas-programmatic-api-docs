...
T = TypeVar("T", bound="CreateBulkEnrollmentDataBody")


@_attrs_define
class CreateBulkEnrollmentDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_bulk_enrollment_data_body = cls(
            user_ids=user_ids,
            course_ids=course_ids,
        )

        create_bulk_enrollment_data_body.additional_properties = d
        return create_bulk_enrollment_data_body
