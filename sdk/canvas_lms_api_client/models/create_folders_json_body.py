...
T = TypeVar("T", bound="CreateFoldersJsonBody")


@_attrs_define
class CreateFoldersJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_folders_json_body = cls(
            name=name,
            lock_at=lock_at,
            unlock_at=unlock_at,
        )

        create_folders_json_body.additional_properties = d
        return create_folders_json_body
