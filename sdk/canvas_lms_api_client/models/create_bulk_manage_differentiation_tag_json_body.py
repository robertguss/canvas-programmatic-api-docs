...
T = TypeVar("T", bound="CreateBulkManageDifferentiationTagJsonBody")


@_attrs_define
class CreateBulkManageDifferentiationTagJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_bulk_manage_differentiation_tag_json_body = cls(
            operations=operations,
            group_category=group_category,
        )

        create_bulk_manage_differentiation_tag_json_body.additional_properties = d
        return create_bulk_manage_differentiation_tag_json_body
