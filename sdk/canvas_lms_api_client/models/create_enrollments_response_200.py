...
if TYPE_CHECKING:
    from ..models.create_enrollments_response_200_grades import CreateEnrollmentsResponse200Grades
    from ..models.create_enrollments_response_200_user import CreateEnrollmentsResponse200User


T = TypeVar("T", bound="CreateEnrollmentsResponse200")


@_attrs_define
class CreateEnrollmentsResponse200:
    """
    Attributes:
        id (int):
        course_id (int):
        ...
        html_url (str):
        grades (CreateEnrollmentsResponse200Grades):
        user (CreateEnrollmentsResponse200User):
        override_grade (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        grades = CreateEnrollmentsResponse200Grades.from_dict(d.pop("grades"))

        user = CreateEnrollmentsResponse200User.from_dict(d.pop("user"))
        ...
        create_enrollments_response_200 = cls(
            id=id,
            course_id=course_id,
            sis_course_id=sis_course_id,
            course_integration_id=course_integration_id,
        ...
        create_enrollments_response_200.additional_properties = d
        return create_enrollments_response_200
