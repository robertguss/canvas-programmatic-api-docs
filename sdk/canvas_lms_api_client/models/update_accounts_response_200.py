...
T = TypeVar("T", bound="UpdateAccountsResponse200")


@_attrs_define
class UpdateAccountsResponse200:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_accounts_response_200 = cls(
            id=id,
            name=name,
            uuid=uuid,
            parent_account_id=parent_account_id,
        ...
        update_accounts_response_200.additional_properties = d
        return update_accounts_response_200
