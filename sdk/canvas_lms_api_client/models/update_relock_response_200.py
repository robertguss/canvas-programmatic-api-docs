...
T = TypeVar("T", bound="UpdateRelockResponse200")


@_attrs_define
class UpdateRelockResponse200:
    """
    Attributes:
        id (int):
        workflow_state (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_relock_response_200 = cls(
            id=id,
            workflow_state=workflow_state,
            position=position,
            name=name,
        ...
        update_relock_response_200.additional_properties = d
        return update_relock_response_200
