...
T = TypeVar("T", bound="UpdateItemsDataBody")


@_attrs_define
class UpdateItemsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_items_data_body.additional_properties = d
        return update_items_data_body
