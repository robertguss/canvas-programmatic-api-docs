...
T = TypeVar("T", bound="UpdateConversationsJsonBody")


@_attrs_define
class UpdateConversationsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_conversations_json_body = cls(
            conversation_ids=conversation_ids,
            event=event,
        )

        update_conversations_json_body.additional_properties = d
        return update_conversations_json_body
