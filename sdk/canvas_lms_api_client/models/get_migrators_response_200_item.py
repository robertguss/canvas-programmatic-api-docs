...
T = TypeVar("T", bound="GetMigratorsResponse200Item")


@_attrs_define
class GetMigratorsResponse200Item:
    """
    Attributes:
        type_ (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_migrators_response_200_item = cls(
            type_=type_,
            requires_file_upload=requires_file_upload,
            name=name,
            required_settings=required_settings,
        ...
        get_migrators_response_200_item.additional_properties = d
        return get_migrators_response_200_item
