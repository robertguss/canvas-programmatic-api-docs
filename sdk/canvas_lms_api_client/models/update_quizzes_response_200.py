...
T = TypeVar("T", bound="UpdateQuizzesResponse200")


@_attrs_define
class UpdateQuizzesResponse200:
    """
    Attributes:
        id (str):
        title (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_quizzes_response_200 = cls(
            id=id,
            title=title,
            instructions=instructions,
            assignment_group_id=assignment_group_id,
        ...
        update_quizzes_response_200.additional_properties = d
        return update_quizzes_response_200
