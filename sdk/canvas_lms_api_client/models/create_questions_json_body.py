...
T = TypeVar("T", bound="CreateQuestionsJsonBody")


@_attrs_define
class CreateQuestionsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_questions_json_body = cls(
            questionanswers=questionanswers,
        )

        create_questions_json_body.additional_properties = d
        return create_questions_json_body
