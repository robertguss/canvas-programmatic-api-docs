...
if TYPE_CHECKING:
    from ..models.create_developer_keys_response_200_item_lti_registration import (
        CreateDeveloperKeysResponse200ItemLtiRegistration,
    )
    from ..models.create_developer_keys_response_200_item_public_jwk import CreateDeveloperKeysResponse200ItemPublicJwk
    from ..models.create_developer_keys_response_200_item_tool_configuration import (
        CreateDeveloperKeysResponse200ItemToolConfiguration,
    )


T = TypeVar("T", bound="CreateDeveloperKeysResponse200Item")


@_attrs_define
class CreateDeveloperKeysResponse200Item:
    """
    Attributes:
        id (int):
        name (str):
        ...
        api_key (str):
        tool_configuration (CreateDeveloperKeysResponse200ItemToolConfiguration):
        public_jwk (CreateDeveloperKeysResponse200ItemPublicJwk):
        public_jwk_url (str):
        lti_registration (CreateDeveloperKeysResponse200ItemLtiRegistration):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.create_developer_keys_response_200_item_public_jwk import (
        ...
        tool_configuration = CreateDeveloperKeysResponse200ItemToolConfiguration.from_dict(d.pop("tool_configuration"))

        public_jwk = CreateDeveloperKeysResponse200ItemPublicJwk.from_dict(d.pop("public_jwk"))

        public_jwk_url = d.pop("public_jwk_url")

        lti_registration = CreateDeveloperKeysResponse200ItemLtiRegistration.from_dict(d.pop("lti_registration"))
        ...
        create_developer_keys_response_200_item = cls(
            id=id,
            name=name,
            created_at=created_at,
            updated_at=updated_at,
        ...
        create_developer_keys_response_200_item.additional_properties = d
        return create_developer_keys_response_200_item
