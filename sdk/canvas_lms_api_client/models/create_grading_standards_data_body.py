...
T = TypeVar("T", bound="CreateGradingStandardsDataBody")


@_attrs_define
class CreateGradingStandardsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_grading_standards_data_body = cls(
            title=title,
            grading_scheme_entryname=grading_scheme_entryname,
            grading_scheme_entryvalue=grading_scheme_entryvalue,
        )

        create_grading_standards_data_body.additional_properties = d
        return create_grading_standards_data_body
