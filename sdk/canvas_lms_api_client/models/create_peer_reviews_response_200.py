...
T = TypeVar("T", bound="CreatePeerReviewsResponse200")


@_attrs_define
class CreatePeerReviewsResponse200:
    """
    Attributes:
        assessor_id (int):
        asset_id (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_peer_reviews_response_200 = cls(
            assessor_id=assessor_id,
            asset_id=asset_id,
            asset_type=asset_type,
            id=id,
        ...
        create_peer_reviews_response_200.additional_properties = d
        return create_peer_reviews_response_200
