...
T = TypeVar("T", bound="GetQuizzesResponse200Item")


@_attrs_define
class GetQuizzesResponse200Item:
    """
    Attributes:
        id (str):
        title (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_quizzes_response_200_item = cls(
            id=id,
            title=title,
            instructions=instructions,
            assignment_group_id=assignment_group_id,
        ...
        get_quizzes_response_200_item.additional_properties = d
        return get_quizzes_response_200_item
