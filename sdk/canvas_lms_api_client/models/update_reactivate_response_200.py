...
if TYPE_CHECKING:
    from ..models.update_reactivate_response_200_grades import UpdateReactivateResponse200Grades
    from ..models.update_reactivate_response_200_user import UpdateReactivateResponse200User


T = TypeVar("T", bound="UpdateReactivateResponse200")


@_attrs_define
class UpdateReactivateResponse200:
    """
    Attributes:
        id (int):
        course_id (int):
        ...
        html_url (str):
        grades (UpdateReactivateResponse200Grades):
        user (UpdateReactivateResponse200User):
        override_grade (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        grades = UpdateReactivateResponse200Grades.from_dict(d.pop("grades"))

        user = UpdateReactivateResponse200User.from_dict(d.pop("user"))
        ...
        update_reactivate_response_200 = cls(
            id=id,
            course_id=course_id,
            sis_course_id=sis_course_id,
            course_integration_id=course_integration_id,
        ...
        update_reactivate_response_200.additional_properties = d
        return update_reactivate_response_200
