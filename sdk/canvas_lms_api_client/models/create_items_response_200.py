...
T = TypeVar("T", bound="CreateItemsResponse200")


@_attrs_define
class CreateItemsResponse200:
    """
    Attributes:
        id (str):
        position (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_items_response_200.additional_properties = d
        return create_items_response_200
