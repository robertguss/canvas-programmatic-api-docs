...
T = TypeVar("T", bound="UpdateSsoSettingsResponse200")


@_attrs_define
class UpdateSsoSettingsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_sso_settings_response_200 = cls(
            login_handle_name=login_handle_name,
            change_password_url=change_password_url,
            auth_discovery_url=auth_discovery_url,
            unknown_user_url=unknown_user_url,
        ...
        update_sso_settings_response_200.additional_properties = d
        return update_sso_settings_response_200
