...
if TYPE_CHECKING:
    from ..models.delete_developer_keys_response_200_lti_registration import (
        DeleteDeveloperKeysResponse200LtiRegistration,
    )
    from ..models.delete_developer_keys_response_200_public_jwk import DeleteDeveloperKeysResponse200PublicJwk
    from ..models.delete_developer_keys_response_200_tool_configuration import (
        DeleteDeveloperKeysResponse200ToolConfiguration,
    )


T = TypeVar("T", bound="DeleteDeveloperKeysResponse200")


@_attrs_define
class DeleteDeveloperKeysResponse200:
    """
    Attributes:
        id (int):
        name (str):
        ...
        api_key (str):
        tool_configuration (DeleteDeveloperKeysResponse200ToolConfiguration):
        public_jwk (DeleteDeveloperKeysResponse200PublicJwk):
        public_jwk_url (str):
        lti_registration (DeleteDeveloperKeysResponse200LtiRegistration):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tool_configuration = DeleteDeveloperKeysResponse200ToolConfiguration.from_dict(d.pop("tool_configuration"))

        public_jwk = DeleteDeveloperKeysResponse200PublicJwk.from_dict(d.pop("public_jwk"))

        public_jwk_url = d.pop("public_jwk_url")

        lti_registration = DeleteDeveloperKeysResponse200LtiRegistration.from_dict(d.pop("lti_registration"))
        ...
        delete_developer_keys_response_200 = cls(
            id=id,
            name=name,
            created_at=created_at,
            updated_at=updated_at,
        ...
        delete_developer_keys_response_200.additional_properties = d
        return delete_developer_keys_response_200
