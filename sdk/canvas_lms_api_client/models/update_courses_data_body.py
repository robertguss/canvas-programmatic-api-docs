...
T = TypeVar("T", bound="UpdateCoursesDataBody")


@_attrs_define
class UpdateCoursesDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_courses_data_body = cls(
            course_ids=course_ids,
            event=event,
        )

        update_courses_data_body.additional_properties = d
        return update_courses_data_body
