...
if TYPE_CHECKING:
    from ..models.get_discussion_topics_response_200_item_group_topic_children_item import (
        GetDiscussionTopicsResponse200ItemGroupTopicChildrenItem,
    )
    from ..models.get_discussion_topics_response_200_item_permissions import (
        GetDiscussionTopicsResponse200ItemPermissions,
    )


T = TypeVar("T", bound="GetDiscussionTopicsResponse200Item")


@_attrs_define
class GetDiscussionTopicsResponse200Item:
    """
    Attributes:
        id (int):
        title (str):
        ...
        group_topic_children (list['GetDiscussionTopicsResponse200ItemGroupTopicChildrenItem']):
        root_topic_id (None):
        podcast_url (str):
        discussion_type (str):
        group_category_id (None):
        attachments (None):
        permissions (GetDiscussionTopicsResponse200ItemPermissions):
        allow_rating (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for group_topic_children_item_data in _group_topic_children:
            group_topic_children_item = GetDiscussionTopicsResponse200ItemGroupTopicChildrenItem.from_dict(
                group_topic_children_item_data
            )
        ...
        permissions = GetDiscussionTopicsResponse200ItemPermissions.from_dict(d.pop("permissions"))
        ...
        get_discussion_topics_response_200_item = cls(
            id=id,
            title=title,
            message=message,
            html_url=html_url,
        ...
        get_discussion_topics_response_200_item.additional_properties = d
        return get_discussion_topics_response_200_item
