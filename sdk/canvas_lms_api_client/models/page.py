...
if TYPE_CHECKING:
    from ..models.page_block_editor_attributes import PageBlockEditorAttributes
...
class Page:
    ...
    Attributes:
        ...
        editor (str):
        block_editor_attributes (PageBlockEditorAttributes):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        block_editor_attributes = PageBlockEditorAttributes.from_dict(d.pop("block_editor_attributes"))
