...
T = TypeVar("T", bound="CreateCalendarEventsDataBody")


@_attrs_define
class CreateCalendarEventsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_calendar_events_data_body = cls(
        ...
        create_calendar_events_data_body.additional_properties = d
        return create_calendar_events_data_body
