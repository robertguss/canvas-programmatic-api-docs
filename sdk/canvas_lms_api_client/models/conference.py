...
if TYPE_CHECKING:
    from ..models.conference_user_settings import ConferenceUserSettings
...
class Conference:
    ...
    Attributes:
        ...
        long_running (bool):
        user_settings (ConferenceUserSettings):
        recordings (None):
        url (None):
        join_url (None):
        context_type (None):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_settings = ConferenceUserSettings.from_dict(d.pop("user_settings"))
