...
T = TypeVar("T", bound="CreateErrorReportsDataBody")


@_attrs_define
class CreateErrorReportsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_error_reports_data_body = cls(
            errorsubject=errorsubject,
            errorhttp_env=errorhttp_env,
        )

        create_error_reports_data_body.additional_properties = d
        return create_error_reports_data_body
