...
T = TypeVar("T", bound="CreateLatePolicyDataBody")


@_attrs_define
class CreateLatePolicyDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_late_policy_data_body = cls(
        ...
        create_late_policy_data_body.additional_properties = d
        return create_late_policy_data_body
