...
T = TypeVar("T", bound="UpdateQuizzesDataBody")


@_attrs_define
class UpdateQuizzesDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_quizzes_data_body.additional_properties = d
        return update_quizzes_data_body
