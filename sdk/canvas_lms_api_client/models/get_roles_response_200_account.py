...
T = TypeVar("T", bound="GetRolesResponse200Account")


@_attrs_define
class GetRolesResponse200Account:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_roles_response_200_account = cls(
            id=id,
            name=name,
            parent_account_id=parent_account_id,
            root_account_id=root_account_id,
        ...
        get_roles_response_200_account.additional_properties = d
        return get_roles_response_200_account
