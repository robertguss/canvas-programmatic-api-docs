...
if TYPE_CHECKING:
    from ..models.create_reset_content_response_200_blueprint_restrictions import (
        CreateResetContentResponse200BlueprintRestrictions,
    )
    from ..models.create_reset_content_response_200_blueprint_restrictions_by_object_type import (
        CreateResetContentResponse200BlueprintRestrictionsByObjectType,
    )
    from ..models.create_reset_content_response_200_permissions import CreateResetContentResponse200Permissions


T = TypeVar("T", bound="CreateResetContentResponse200")


@_attrs_define
class CreateResetContentResponse200:
    """
    Attributes:
        id (int):
        sis_course_id (None):
        ...
        permissions (CreateResetContentResponse200Permissions):
        is_public (bool):
        ...
        time_zone (str):
        blueprint (bool):
        blueprint_restrictions (CreateResetContentResponse200BlueprintRestrictions):
        blueprint_restrictions_by_object_type (CreateResetContentResponse200BlueprintRestrictionsByObjectType):
        template (bool):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        permissions = CreateResetContentResponse200Permissions.from_dict(d.pop("permissions"))
        ...
        blueprint_restrictions = CreateResetContentResponse200BlueprintRestrictions.from_dict(
            d.pop("blueprint_restrictions")
        )

        blueprint_restrictions_by_object_type = (
            CreateResetContentResponse200BlueprintRestrictionsByObjectType.from_dict(
        ...
        create_reset_content_response_200 = cls(
            id=id,
            sis_course_id=sis_course_id,
            uuid=uuid,
            integration_id=integration_id,
        ...
        create_reset_content_response_200.additional_properties = d
        return create_reset_content_response_200
