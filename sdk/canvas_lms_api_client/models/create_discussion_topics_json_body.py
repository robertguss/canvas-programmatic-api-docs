...
T = TypeVar("T", bound="CreateDiscussionTopicsJsonBody")


@_attrs_define
class CreateDiscussionTopicsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_discussion_topics_json_body = cls(
        ...
        create_discussion_topics_json_body.additional_properties = d
        return create_discussion_topics_json_body
