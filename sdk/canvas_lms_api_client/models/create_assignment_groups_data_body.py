...
T = TypeVar("T", bound="CreateAssignmentGroupsDataBody")


@_attrs_define
class CreateAssignmentGroupsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_assignment_groups_data_body = cls(
            group_weight=group_weight,
            integration_data=integration_data,
        )

        create_assignment_groups_data_body.additional_properties = d
        return create_assignment_groups_data_body
