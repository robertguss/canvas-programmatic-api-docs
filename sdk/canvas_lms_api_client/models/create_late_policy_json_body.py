...
T = TypeVar("T", bound="CreateLatePolicyJsonBody")


@_attrs_define
class CreateLatePolicyJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_late_policy_json_body = cls(
        ...
        create_late_policy_json_body.additional_properties = d
        return create_late_policy_json_body
