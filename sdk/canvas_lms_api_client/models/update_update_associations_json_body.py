...
T = TypeVar("T", bound="UpdateUpdateAssociationsJsonBody")


@_attrs_define
class UpdateUpdateAssociationsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_update_associations_json_body = cls(
            course_ids_to_add=course_ids_to_add,
            course_ids_to_remove=course_ids_to_remove,
        )

        update_update_associations_json_body.additional_properties = d
        return update_update_associations_json_body
