...
T = TypeVar("T", bound="CreateAddRecipientsJsonBody")


@_attrs_define
class CreateAddRecipientsJsonBody:
    r"""
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_add_recipients_json_body = cls(
            recipients=recipients,
        )

        create_add_recipients_json_body.additional_properties = d
        return create_add_recipients_json_body
