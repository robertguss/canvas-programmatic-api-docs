...
T = TypeVar("T", bound="GetOutcomesResponse200")


@_attrs_define
class GetOutcomesResponse200:
    """
    Attributes:
        id (int):
        url (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_outcomes_response_200.additional_properties = d
        return get_outcomes_response_200
