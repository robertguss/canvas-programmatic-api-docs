...
T = TypeVar("T", bound="GetByPathResponse200Item")


@_attrs_define
class GetByPathResponse200Item:
    """
    Attributes:
        context_type (str):
        context_id (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_by_path_response_200_item = cls(
            context_type=context_type,
            context_id=context_id,
            files_count=files_count,
            position=position,
        ...
        get_by_path_response_200_item.additional_properties = d
        return get_by_path_response_200_item
