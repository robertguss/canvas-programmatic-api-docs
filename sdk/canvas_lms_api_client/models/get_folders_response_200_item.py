...
T = TypeVar("T", bound="GetFoldersResponse200Item")


@_attrs_define
class GetFoldersResponse200Item:
    """
    Attributes:
        context_type (str):
        context_id (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_folders_response_200_item = cls(
            context_type=context_type,
            context_id=context_id,
            files_count=files_count,
            position=position,
        ...
        get_folders_response_200_item.additional_properties = d
        return get_folders_response_200_item
