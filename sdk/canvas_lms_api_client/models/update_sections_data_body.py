...
T = TypeVar("T", bound="UpdateSectionsDataBody")


@_attrs_define
class UpdateSectionsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_sections_data_body = cls(
            course_sectionstart_at=course_sectionstart_at,
            course_sectionend_at=course_sectionend_at,
        )

        update_sections_data_body.additional_properties = d
        return update_sections_data_body
