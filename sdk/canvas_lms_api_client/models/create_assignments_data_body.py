...
T = TypeVar("T", bound="CreateAssignmentsDataBody")


@_attrs_define
class CreateAssignmentsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_assignments_data_body = cls(
        ...
        create_assignments_data_body.additional_properties = d
        return create_assignments_data_body
