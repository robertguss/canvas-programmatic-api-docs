...
T = TypeVar("T", bound="UpdateAccountsDataBody")


@_attrs_define
class UpdateAccountsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_accounts_data_body = cls(
            accountsettingspassword_policy=accountsettingspassword_policy,
            accountservices=accountservices,
        )

        update_accounts_data_body.additional_properties = d
        return update_accounts_data_body
