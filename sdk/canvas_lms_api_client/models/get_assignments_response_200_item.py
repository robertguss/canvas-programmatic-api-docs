...
if TYPE_CHECKING:
    from ..models.get_assignments_response_200_item_integration_data import GetAssignmentsResponse200ItemIntegrationData
    from ..models.get_assignments_response_200_item_needs_grading_count_by_section_item import (
        GetAssignmentsResponse200ItemNeedsGradingCountBySectionItem,
    )
    from ..models.get_assignments_response_200_item_rubric_settings import GetAssignmentsResponse200ItemRubricSettings


T = TypeVar("T", bound="GetAssignmentsResponse200Item")


@_attrs_define
class GetAssignmentsResponse200Item:
    """
    Attributes:
        id (int):
        name (str):
        ...
        needs_grading_count_by_section (list['GetAssignmentsResponse200ItemNeedsGradingCountBySectionItem']):
        position (int):
        post_to_sis (bool):
        integration_id (str):
        integration_data (GetAssignmentsResponse200ItemIntegrationData):
        ...
        rubric_settings (GetAssignmentsResponse200ItemRubricSettings):
        rubric (None):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.get_assignments_response_200_item_integration_data import (
            GetAssignmentsResponse200ItemIntegrationData,
        )
        from ..models.get_assignments_response_200_item_needs_grading_count_by_section_item import (
            GetAssignmentsResponse200ItemNeedsGradingCountBySectionItem,
        )
        from ..models.get_assignments_response_200_item_rubric_settings import (
        ...
        for needs_grading_count_by_section_item_data in _needs_grading_count_by_section:
            needs_grading_count_by_section_item = GetAssignmentsResponse200ItemNeedsGradingCountBySectionItem.from_dict(
        ...
        integration_data = GetAssignmentsResponse200ItemIntegrationData.from_dict(d.pop("integration_data"))
        ...
        rubric_settings = GetAssignmentsResponse200ItemRubricSettings.from_dict(d.pop("rubric_settings"))
        ...
        get_assignments_response_200_item = cls(
            id=id,
            name=name,
            description=description,
            created_at=created_at,
        ...
        get_assignments_response_200_item.additional_properties = d
        return get_assignments_response_200_item
