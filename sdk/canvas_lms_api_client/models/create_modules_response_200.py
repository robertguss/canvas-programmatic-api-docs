...
T = TypeVar("T", bound="CreateModulesResponse200")


@_attrs_define
class CreateModulesResponse200:
    """
    Attributes:
        id (int):
        workflow_state (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_modules_response_200 = cls(
            id=id,
            workflow_state=workflow_state,
            position=position,
            name=name,
        ...
        create_modules_response_200.additional_properties = d
        return create_modules_response_200
