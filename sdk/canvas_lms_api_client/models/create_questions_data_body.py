...
T = TypeVar("T", bound="CreateQuestionsDataBody")


@_attrs_define
class CreateQuestionsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_questions_data_body = cls(
            questionanswers=questionanswers,
        )

        create_questions_data_body.additional_properties = d
        return create_questions_data_body
