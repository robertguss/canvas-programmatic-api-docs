...
if TYPE_CHECKING:
    from ..models.names_and_role_membership_message_item import NamesAndRoleMembershipMessageItem


T = TypeVar("T", bound="NamesAndRoleMembership")


@_attrs_define
class NamesAndRoleMembership:
    """
    Attributes:
        status (str):
        name (str):
        ...
        user_id (str):
        roles (list[str]):
        message (list['NamesAndRoleMembershipMessageItem']):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for message_item_data in _message:
            message_item = NamesAndRoleMembershipMessageItem.from_dict(message_item_data)

            message.append(message_item)

        names_and_role_membership = cls(
            status=status,
            name=name,
            picture=picture,
            given_name=given_name,
        ...
        names_and_role_membership.additional_properties = d
        return names_and_role_membership
