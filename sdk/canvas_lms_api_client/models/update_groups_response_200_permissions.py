...
T = TypeVar("T", bound="UpdateGroupsResponse200Permissions")


@_attrs_define
class UpdateGroupsResponse200Permissions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_groups_response_200_permissions = cls(
            create_discussion_topic=create_discussion_topic,
            create_announcement=create_announcement,
        )

        update_groups_response_200_permissions.additional_properties = d
        return update_groups_response_200_permissions
