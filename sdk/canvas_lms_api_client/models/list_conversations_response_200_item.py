...
T = TypeVar("T", bound="ListConversationsResponse200Item")


@_attrs_define
class ListConversationsResponse200Item:
    """
    Attributes:
        id (int):
        subject (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_conversations_response_200_item = cls(
            id=id,
            subject=subject,
            workflow_state=workflow_state,
            last_message=last_message,
        ...
        list_conversations_response_200_item.additional_properties = d
        return list_conversations_response_200_item
