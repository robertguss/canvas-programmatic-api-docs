...
T = TypeVar("T", bound="DeleteCrosslistResponse200")


@_attrs_define
class DeleteCrosslistResponse200:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_crosslist_response_200 = cls(
            id=id,
            name=name,
            sis_section_id=sis_section_id,
            integration_id=integration_id,
        ...
        delete_crosslist_response_200.additional_properties = d
        return delete_crosslist_response_200
