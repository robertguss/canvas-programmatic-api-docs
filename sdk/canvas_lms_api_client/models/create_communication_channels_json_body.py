...
T = TypeVar("T", bound="CreateCommunicationChannelsJsonBody")


@_attrs_define
class CreateCommunicationChannelsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_communication_channels_json_body = cls(
            communication_channeladdress=communication_channeladdress,
            communication_channeltype=communication_channeltype,
        )

        create_communication_channels_json_body.additional_properties = d
        return create_communication_channels_json_body
