...
if TYPE_CHECKING:
    from ..models.names_and_role_message_httpspurl_imsglobal_orgspeclticlaimcustom import (
        NamesAndRoleMessageHttpspurlImsglobalOrgspeclticlaimcustom,
    )


T = TypeVar("T", bound="NamesAndRoleMessage")


@_attrs_define
class NamesAndRoleMessage:
    """
    Attributes:
        ...
        httpspurl_imsglobal_orgspeclticlaimcustom (NamesAndRoleMessageHttpspurlImsglobalOrgspeclticlaimcustom):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        httpspurl_imsglobal_orgspeclticlaimcustom = (
            NamesAndRoleMessageHttpspurlImsglobalOrgspeclticlaimcustom.from_dict(
                d.pop("https://purl.imsglobal.org/spec/lti/claim/custom")
            )
        )

        names_and_role_message = cls(
        ...
        names_and_role_message.additional_properties = d
        return names_and_role_message
