...
T = TypeVar("T", bound="DeleteOutcomesResponse200")


@_attrs_define
class DeleteOutcomesResponse200:
    """
    Attributes:
        url (str):
        context_id (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_outcomes_response_200 = cls(
            url=url,
            context_id=context_id,
            context_type=context_type,
            outcome_group=outcome_group,
        ...
        delete_outcomes_response_200.additional_properties = d
        return delete_outcomes_response_200
