...
T = TypeVar("T", bound="CreateQuizzesJsonBody")


@_attrs_define
class CreateQuizzesJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_quizzes_json_body.additional_properties = d
        return create_quizzes_json_body
