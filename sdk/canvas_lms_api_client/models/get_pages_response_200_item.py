...
if TYPE_CHECKING:
    from ..models.get_pages_response_200_item_block_editor_attributes import (
        GetPagesResponse200ItemBlockEditorAttributes,
    )


T = TypeVar("T", bound="GetPagesResponse200Item")


@_attrs_define
class GetPagesResponse200Item:
    """
    Attributes:
        page_id (int):
        url (str):
        ...
        editor (str):
        block_editor_attributes (GetPagesResponse200ItemBlockEditorAttributes):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        block_editor_attributes = GetPagesResponse200ItemBlockEditorAttributes.from_dict(
            d.pop("block_editor_attributes")
        )

        get_pages_response_200_item = cls(
            page_id=page_id,
            url=url,
            title=title,
            created_at=created_at,
        ...
        get_pages_response_200_item.additional_properties = d
        return get_pages_response_200_item
