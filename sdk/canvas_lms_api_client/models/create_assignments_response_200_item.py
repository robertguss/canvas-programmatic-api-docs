...
if TYPE_CHECKING:
    from ..models.create_assignments_response_200_item_integration_data import (
        CreateAssignmentsResponse200ItemIntegrationData,
    )
    from ..models.create_assignments_response_200_item_needs_grading_count_by_section_item import (
        CreateAssignmentsResponse200ItemNeedsGradingCountBySectionItem,
    )
    from ..models.create_assignments_response_200_item_rubric_settings import (
        CreateAssignmentsResponse200ItemRubricSettings,
    )


T = TypeVar("T", bound="CreateAssignmentsResponse200Item")


@_attrs_define
class CreateAssignmentsResponse200Item:
    """
    Attributes:
        id (int):
        name (str):
        ...
        needs_grading_count_by_section (list['CreateAssignmentsResponse200ItemNeedsGradingCountBySectionItem']):
        position (int):
        post_to_sis (bool):
        integration_id (str):
        integration_data (CreateAssignmentsResponse200ItemIntegrationData):
        ...
        rubric_settings (CreateAssignmentsResponse200ItemRubricSettings):
        rubric (None):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for needs_grading_count_by_section_item_data in _needs_grading_count_by_section:
            needs_grading_count_by_section_item = (
                CreateAssignmentsResponse200ItemNeedsGradingCountBySectionItem.from_dict(
        ...
        integration_data = CreateAssignmentsResponse200ItemIntegrationData.from_dict(d.pop("integration_data"))
        ...
        rubric_settings = CreateAssignmentsResponse200ItemRubricSettings.from_dict(d.pop("rubric_settings"))
        ...
        create_assignments_response_200_item = cls(
            id=id,
            name=name,
            description=description,
            created_at=created_at,
        ...
        create_assignments_response_200_item.additional_properties = d
        return create_assignments_response_200_item
