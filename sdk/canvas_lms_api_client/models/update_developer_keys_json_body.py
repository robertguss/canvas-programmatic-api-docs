...
T = TypeVar("T", bound="UpdateDeveloperKeysJsonBody")


@_attrs_define
class UpdateDeveloperKeysJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_developer_keys_json_body = cls(
            developer_key=developer_key,
            developer_keyredirect_uris=developer_keyredirect_uris,
            developer_keyscopes=developer_keyscopes,
        )

        update_developer_keys_json_body.additional_properties = d
        return update_developer_keys_json_body
