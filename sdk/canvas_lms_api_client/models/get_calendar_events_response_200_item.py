...
T = TypeVar("T", bound="GetCalendarEventsResponse200Item")


@_attrs_define
class GetCalendarEventsResponse200Item:
    """
    Attributes:
        id (int):
        title (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_calendar_events_response_200_item = cls(
            id=id,
            title=title,
            start_at=start_at,
            end_at=end_at,
        ...
        get_calendar_events_response_200_item.additional_properties = d
        return get_calendar_events_response_200_item
