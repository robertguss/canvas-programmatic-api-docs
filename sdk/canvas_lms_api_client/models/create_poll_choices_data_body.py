...
T = TypeVar("T", bound="CreatePollChoicesDataBody")


@_attrs_define
class CreatePollChoicesDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_poll_choices_data_body = cls(
            poll_choicestext=poll_choicestext,
        )

        create_poll_choices_data_body.additional_properties = d
        return create_poll_choices_data_body
