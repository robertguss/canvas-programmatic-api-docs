...
T = TypeVar("T", bound="CreateSelfRegistrationDataBody")


@_attrs_define
class CreateSelfRegistrationDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_self_registration_data_body = cls(
            username=username,
            userterms_of_use=userterms_of_use,
            pseudonymunique_id=pseudonymunique_id,
        )

        create_self_registration_data_body.additional_properties = d
        return create_self_registration_data_body
