...
T = TypeVar("T", bound="CreateExternalToolsJsonBody")


@_attrs_define
class CreateExternalToolsJsonBody:
    r"""
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_external_tools_json_body = cls(
            client_id=client_id,
            name=name,
        ...
        create_external_tools_json_body.additional_properties = d
        return create_external_tools_json_body
