...
T = TypeVar("T", bound="DeleteOutcomeGroupsResponse200")


@_attrs_define
class DeleteOutcomeGroupsResponse200:
    """
    Attributes:
        id (int):
        url (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_outcome_groups_response_200 = cls(
            id=id,
            url=url,
            parent_outcome_group=parent_outcome_group,
            context_id=context_id,
        ...
        delete_outcome_groups_response_200.additional_properties = d
        return delete_outcome_groups_response_200
