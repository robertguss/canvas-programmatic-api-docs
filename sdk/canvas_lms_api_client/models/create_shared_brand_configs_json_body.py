...
T = TypeVar("T", bound="CreateSharedBrandConfigsJsonBody")


@_attrs_define
class CreateSharedBrandConfigsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_shared_brand_configs_json_body = cls(
            shared_brand_configname=shared_brand_configname,
            shared_brand_configbrand_config_md5=shared_brand_configbrand_config_md5,
        )

        create_shared_brand_configs_json_body.additional_properties = d
        return create_shared_brand_configs_json_body
