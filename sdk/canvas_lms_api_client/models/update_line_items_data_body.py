...
T = TypeVar("T", bound="UpdateLineItemsDataBody")


@_attrs_define
class UpdateLineItemsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_line_items_data_body = cls(
            score_maximum=score_maximum,
        )

        update_line_items_data_body.additional_properties = d
        return update_line_items_data_body
