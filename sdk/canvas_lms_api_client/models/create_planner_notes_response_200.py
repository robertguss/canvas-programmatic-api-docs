...
T = TypeVar("T", bound="CreatePlannerNotesResponse200")


@_attrs_define
class CreatePlannerNotesResponse200:
    """
    Attributes:
        id (int):
        title (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_planner_notes_response_200 = cls(
            id=id,
            title=title,
            description=description,
            user_id=user_id,
        ...
        create_planner_notes_response_200.additional_properties = d
        return create_planner_notes_response_200
