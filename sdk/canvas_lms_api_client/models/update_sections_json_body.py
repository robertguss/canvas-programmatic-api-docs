...
T = TypeVar("T", bound="UpdateSectionsJsonBody")


@_attrs_define
class UpdateSectionsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_sections_json_body = cls(
            course_sectionstart_at=course_sectionstart_at,
            course_sectionend_at=course_sectionend_at,
        )

        update_sections_json_body.additional_properties = d
        return update_sections_json_body
