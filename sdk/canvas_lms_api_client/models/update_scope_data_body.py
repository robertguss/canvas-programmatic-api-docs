...
T = TypeVar("T", bound="UpdateScopeDataBody")


@_attrs_define
class UpdateScopeDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_scope_data_body = cls(
            ns=ns,
            data=data,
        )

        update_scope_data_body.additional_properties = d
        return update_scope_data_body
