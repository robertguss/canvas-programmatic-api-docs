...
T = TypeVar("T", bound="CreatePlannerNotesDataBody")


@_attrs_define
class CreatePlannerNotesDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_planner_notes_data_body = cls(
            todo_date=todo_date,
        )

        create_planner_notes_data_body.additional_properties = d
        return create_planner_notes_data_body
