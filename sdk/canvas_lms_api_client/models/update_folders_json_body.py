...
T = TypeVar("T", bound="UpdateFoldersJsonBody")


@_attrs_define
class UpdateFoldersJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_folders_json_body = cls(
            lock_at=lock_at,
            unlock_at=unlock_at,
        )

        update_folders_json_body.additional_properties = d
        return update_folders_json_body
