...
T = TypeVar("T", bound="CreateGradingPeriodSetsJsonBody")


@_attrs_define
class CreateGradingPeriodSetsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_grading_period_sets_json_body = cls(
            enrollment_term_ids=enrollment_term_ids,
            grading_period_settitle=grading_period_settitle,
        )

        create_grading_period_sets_json_body.additional_properties = d
        return create_grading_period_sets_json_body
