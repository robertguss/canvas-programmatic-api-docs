...
T = TypeVar("T", bound="UpdateCspSettingsJsonBody")


@_attrs_define
class UpdateCspSettingsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_csp_settings_json_body = cls(
            status=status,
        )

        update_csp_settings_json_body.additional_properties = d
        return update_csp_settings_json_body
