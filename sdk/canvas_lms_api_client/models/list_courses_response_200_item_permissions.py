...
T = TypeVar("T", bound="ListCoursesResponse200ItemPermissions")


@_attrs_define
class ListCoursesResponse200ItemPermissions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_courses_response_200_item_permissions = cls(
            create_discussion_topic=create_discussion_topic,
            create_announcement=create_announcement,
        )

        list_courses_response_200_item_permissions.additional_properties = d
        return list_courses_response_200_item_permissions
