...
T = TypeVar("T", bound="UpdateAccountCalendarsResponse200")


@_attrs_define
class UpdateAccountCalendarsResponse200:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_account_calendars_response_200 = cls(
            id=id,
            name=name,
            parent_account_id=parent_account_id,
            root_account_id=root_account_id,
        ...
        update_account_calendars_response_200.additional_properties = d
        return update_account_calendars_response_200
