...
if TYPE_CHECKING:
    from ..models.get_enrollments_response_200_item_grades import GetEnrollmentsResponse200ItemGrades
    from ..models.get_enrollments_response_200_item_user import GetEnrollmentsResponse200ItemUser


T = TypeVar("T", bound="GetEnrollmentsResponse200Item")


@_attrs_define
class GetEnrollmentsResponse200Item:
    """
    Attributes:
        id (int):
        course_id (int):
        ...
        html_url (str):
        grades (GetEnrollmentsResponse200ItemGrades):
        user (GetEnrollmentsResponse200ItemUser):
        override_grade (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        grades = GetEnrollmentsResponse200ItemGrades.from_dict(d.pop("grades"))

        user = GetEnrollmentsResponse200ItemUser.from_dict(d.pop("user"))
        ...
        get_enrollments_response_200_item = cls(
            id=id,
            course_id=course_id,
            sis_course_id=sis_course_id,
            course_integration_id=course_integration_id,
        ...
        get_enrollments_response_200_item.additional_properties = d
        return get_enrollments_response_200_item
