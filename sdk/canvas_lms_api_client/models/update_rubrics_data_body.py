...
T = TypeVar("T", bound="UpdateRubricsDataBody")


@_attrs_define
class UpdateRubricsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_rubrics_data_body = cls(
            rubriccriteria=rubriccriteria,
        )

        update_rubrics_data_body.additional_properties = d
        return update_rubrics_data_body
