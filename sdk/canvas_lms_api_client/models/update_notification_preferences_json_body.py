...
T = TypeVar("T", bound="UpdateNotificationPreferencesJsonBody")


@_attrs_define
class UpdateNotificationPreferencesJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_notification_preferences_json_body = cls(
            notification_preferencesfrequency=notification_preferencesfrequency,
        )

        update_notification_preferences_json_body.additional_properties = d
        return update_notification_preferences_json_body
