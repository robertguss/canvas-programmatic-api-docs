...
T = TypeVar("T", bound="CreateUsersDataBody")


@_attrs_define
class CreateUsersDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_users_data_body = cls(
            pseudonymunique_id=pseudonymunique_id,
            destination=destination,
        )

        create_users_data_body.additional_properties = d
        return create_users_data_body
