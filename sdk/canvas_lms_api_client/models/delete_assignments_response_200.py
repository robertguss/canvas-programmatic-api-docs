...
if TYPE_CHECKING:
    from ..models.delete_assignments_response_200_integration_data import DeleteAssignmentsResponse200IntegrationData
    from ..models.delete_assignments_response_200_needs_grading_count_by_section_item import (
        DeleteAssignmentsResponse200NeedsGradingCountBySectionItem,
    )
    from ..models.delete_assignments_response_200_rubric_settings import DeleteAssignmentsResponse200RubricSettings


T = TypeVar("T", bound="DeleteAssignmentsResponse200")


@_attrs_define
class DeleteAssignmentsResponse200:
    """
    Attributes:
        id (int):
        name (str):
        ...
        needs_grading_count_by_section (list['DeleteAssignmentsResponse200NeedsGradingCountBySectionItem']):
        position (int):
        post_to_sis (bool):
        integration_id (str):
        integration_data (DeleteAssignmentsResponse200IntegrationData):
        ...
        rubric_settings (DeleteAssignmentsResponse200RubricSettings):
        rubric (None):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.delete_assignments_response_200_integration_data import (
        ...
        for needs_grading_count_by_section_item_data in _needs_grading_count_by_section:
            needs_grading_count_by_section_item = DeleteAssignmentsResponse200NeedsGradingCountBySectionItem.from_dict(
        ...
        integration_data = DeleteAssignmentsResponse200IntegrationData.from_dict(d.pop("integration_data"))
        ...
        rubric_settings = DeleteAssignmentsResponse200RubricSettings.from_dict(d.pop("rubric_settings"))
        ...
        delete_assignments_response_200 = cls(
            id=id,
            name=name,
            description=description,
            created_at=created_at,
        ...
        delete_assignments_response_200.additional_properties = d
        return delete_assignments_response_200
