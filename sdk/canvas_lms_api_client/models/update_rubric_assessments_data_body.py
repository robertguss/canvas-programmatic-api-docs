...
T = TypeVar("T", bound="UpdateRubricAssessmentsDataBody")


@_attrs_define
class UpdateRubricAssessmentsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_rubric_assessments_data_body = cls(
            rubric_assessment=rubric_assessment,
        )

        update_rubric_assessments_data_body.additional_properties = d
        return update_rubric_assessments_data_body
