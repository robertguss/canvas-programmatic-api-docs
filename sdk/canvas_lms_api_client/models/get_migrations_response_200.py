...
T = TypeVar("T", bound="GetMigrationsResponse200")


@_attrs_define
class GetMigrationsResponse200:
    """
    Attributes:
        id (int):
        template_id (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_migrations_response_200 = cls(
            id=id,
            template_id=template_id,
            subscription_id=subscription_id,
            user_id=user_id,
        ...
        get_migrations_response_200.additional_properties = d
        return get_migrations_response_200
