...
T = TypeVar("T", bound="CreateTimetableEventsJsonBody")


@_attrs_define
class CreateTimetableEventsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_timetable_events_json_body = cls(
            events=events,
            eventsstart_at=eventsstart_at,
            eventsend_at=eventsend_at,
        )

        create_timetable_events_json_body.additional_properties = d
        return create_timetable_events_json_body
