...
if TYPE_CHECKING:
    from ..models.get_courses_response_200_blueprint_restrictions import GetCoursesResponse200BlueprintRestrictions
    from ..models.get_courses_response_200_blueprint_restrictions_by_object_type import (
        GetCoursesResponse200BlueprintRestrictionsByObjectType,
    )
    from ..models.get_courses_response_200_permissions import GetCoursesResponse200Permissions


T = TypeVar("T", bound="GetCoursesResponse200")


@_attrs_define
class GetCoursesResponse200:
    """
    Attributes:
        id (int):
        sis_course_id (None):
        ...
        permissions (GetCoursesResponse200Permissions):
        is_public (bool):
        ...
        time_zone (str):
        blueprint (bool):
        blueprint_restrictions (GetCoursesResponse200BlueprintRestrictions):
        blueprint_restrictions_by_object_type (GetCoursesResponse200BlueprintRestrictionsByObjectType):
        template (bool):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        permissions = GetCoursesResponse200Permissions.from_dict(d.pop("permissions"))
        ...
        blueprint_restrictions = GetCoursesResponse200BlueprintRestrictions.from_dict(d.pop("blueprint_restrictions"))

        blueprint_restrictions_by_object_type = GetCoursesResponse200BlueprintRestrictionsByObjectType.from_dict(
            d.pop("blueprint_restrictions_by_object_type")
        )

        template = d.pop("template")

        get_courses_response_200 = cls(
            id=id,
            sis_course_id=sis_course_id,
            uuid=uuid,
            integration_id=integration_id,
        ...
        get_courses_response_200.additional_properties = d
        return get_courses_response_200
