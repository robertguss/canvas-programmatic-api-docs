...
T = TypeVar("T", bound="CreateItemsDataBody")


@_attrs_define
class CreateItemsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_items_data_body.additional_properties = d
        return create_items_data_body
