...
T = TypeVar("T", bound="GetPlannerNotesResponse200")


@_attrs_define
class GetPlannerNotesResponse200:
    """
    Attributes:
        id (int):
        title (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_planner_notes_response_200 = cls(
            id=id,
            title=title,
            description=description,
            user_id=user_id,
        ...
        get_planner_notes_response_200.additional_properties = d
        return get_planner_notes_response_200
