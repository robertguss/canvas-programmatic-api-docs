...
T = TypeVar("T", bound="UpdateCoursePacingJsonBody")


@_attrs_define
class UpdateCoursePacingJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_course_pacing_json_body = cls(
            course_id=course_id,
            course_pace_id=course_pace_id,
            end_date=end_date,
        )

        update_course_pacing_json_body.additional_properties = d
        return update_course_pacing_json_body
