...
T = TypeVar("T", bound="CreateSectionsDataBody")


@_attrs_define
class CreateSectionsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_sections_data_body = cls(
            course_sectionstart_at=course_sectionstart_at,
            course_sectionend_at=course_sectionend_at,
        )

        create_sections_data_body.additional_properties = d
        return create_sections_data_body
