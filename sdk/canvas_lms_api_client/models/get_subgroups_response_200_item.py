...
T = TypeVar("T", bound="GetSubgroupsResponse200Item")


@_attrs_define
class GetSubgroupsResponse200Item:
    """
    Attributes:
        id (int):
        url (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_subgroups_response_200_item = cls(
            id=id,
            url=url,
            parent_outcome_group=parent_outcome_group,
            context_id=context_id,
        ...
        get_subgroups_response_200_item.additional_properties = d
        return get_subgroups_response_200_item
