...
T = TypeVar("T", bound="UpdateDeveloperKeysDataBody")


@_attrs_define
class UpdateDeveloperKeysDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_developer_keys_data_body = cls(
            developer_key=developer_key,
            developer_keyredirect_uris=developer_keyredirect_uris,
            developer_keyscopes=developer_keyscopes,
        )

        update_developer_keys_data_body.additional_properties = d
        return update_developer_keys_data_body
