...
T = TypeVar("T", bound="UpdateRestoreResponse200")


@_attrs_define
class UpdateRestoreResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_restore_response_200 = cls(
            identifier_format=identifier_format,
            auth_type=auth_type,
            id=id,
            log_out_url=log_out_url,
        ...
        update_restore_response_200.additional_properties = d
        return update_restore_response_200
