...
T = TypeVar("T", bound="GetMigrationIssuesResponse200Item")


@_attrs_define
class GetMigrationIssuesResponse200Item:
    """
    Attributes:
        id (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_migration_issues_response_200_item = cls(
            id=id,
            content_migration_url=content_migration_url,
            description=description,
            workflow_state=workflow_state,
        ...
        get_migration_issues_response_200_item.additional_properties = d
        return get_migration_issues_response_200_item
