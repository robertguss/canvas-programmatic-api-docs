...
T = TypeVar("T", bound="UpdateRestrictItemDataBody")


@_attrs_define
class UpdateRestrictItemDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_restrict_item_data_body = cls(
            restrictions=restrictions,
        )

        update_restrict_item_data_body.additional_properties = d
        return update_restrict_item_data_body
