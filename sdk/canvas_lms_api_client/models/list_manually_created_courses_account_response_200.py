...
T = TypeVar("T", bound="ListManuallyCreatedCoursesAccountResponse200")


@_attrs_define
class ListManuallyCreatedCoursesAccountResponse200:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_manually_created_courses_account_response_200 = cls(
            id=id,
            name=name,
            uuid=uuid,
            parent_account_id=parent_account_id,
        ...
        list_manually_created_courses_account_response_200.additional_properties = d
        return list_manually_created_courses_account_response_200
