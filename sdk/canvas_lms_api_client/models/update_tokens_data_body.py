...
T = TypeVar("T", bound="UpdateTokensDataBody")


@_attrs_define
class UpdateTokensDataBody:
    """
    Attributes:
        tokenexpires_at (Union[Unset, str]): The time at which the token will expire.
        tokenscopes (Union[Unset, str]): The scopes to associate with the token.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_tokens_data_body = cls(
            tokenexpires_at=tokenexpires_at,
            tokenscopes=tokenscopes,
        )

        update_tokens_data_body.additional_properties = d
        return update_tokens_data_body
