...
T = TypeVar("T", bound="GetFoldersResponse200")


@_attrs_define
class GetFoldersResponse200:
    """
    Attributes:
        context_type (str):
        context_id (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_folders_response_200.additional_properties = d
        return get_folders_response_200
