...
if TYPE_CHECKING:
    from ..models.update_last_attended_response_200_grades import UpdateLastAttendedResponse200Grades
    from ..models.update_last_attended_response_200_user import UpdateLastAttendedResponse200User


T = TypeVar("T", bound="UpdateLastAttendedResponse200")


@_attrs_define
class UpdateLastAttendedResponse200:
    """
    Attributes:
        id (int):
        course_id (int):
        ...
        html_url (str):
        grades (UpdateLastAttendedResponse200Grades):
        user (UpdateLastAttendedResponse200User):
        override_grade (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        grades = UpdateLastAttendedResponse200Grades.from_dict(d.pop("grades"))

        user = UpdateLastAttendedResponse200User.from_dict(d.pop("user"))
        ...
        update_last_attended_response_200 = cls(
            id=id,
            course_id=course_id,
            sis_course_id=sis_course_id,
            course_integration_id=course_integration_id,
        ...
        update_last_attended_response_200.additional_properties = d
        return update_last_attended_response_200
