...
T = TypeVar("T", bound="CreateCopyFolderDataBody")


@_attrs_define
class CreateCopyFolderDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_copy_folder_data_body = cls(
            source_folder_id=source_folder_id,
        )

        create_copy_folder_data_body.additional_properties = d
        return create_copy_folder_data_body
