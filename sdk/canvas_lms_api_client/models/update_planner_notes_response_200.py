...
T = TypeVar("T", bound="UpdatePlannerNotesResponse200")


@_attrs_define
class UpdatePlannerNotesResponse200:
    """
    Attributes:
        id (int):
        title (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_planner_notes_response_200 = cls(
            id=id,
            title=title,
            description=description,
            user_id=user_id,
        ...
        update_planner_notes_response_200.additional_properties = d
        return update_planner_notes_response_200
