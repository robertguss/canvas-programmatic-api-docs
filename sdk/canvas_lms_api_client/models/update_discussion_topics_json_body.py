...
T = TypeVar("T", bound="UpdateDiscussionTopicsJsonBody")


@_attrs_define
class UpdateDiscussionTopicsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_discussion_topics_json_body = cls(
            delayed_post_at=delayed_post_at,
            lock_at=lock_at,
            assignment=assignment,
        )

        update_discussion_topics_json_body.additional_properties = d
        return update_discussion_topics_json_body
