...
T = TypeVar("T", bound="CreateAccommodationsDataBody")


@_attrs_define
class CreateAccommodationsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_accommodations_data_body = cls(
            course_id=course_id,
            assignment_id=assignment_id,
            user_id=user_id,
        )

        create_accommodations_data_body.additional_properties = d
        return create_accommodations_data_body
