...
T = TypeVar("T", bound="CreateSaveEnabledAccountCalendarsJsonBody")


@_attrs_define
class CreateSaveEnabledAccountCalendarsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_save_enabled_account_calendars_json_body = cls(
            enabled_account_calendars=enabled_account_calendars,
        )

        create_save_enabled_account_calendars_json_body.additional_properties = d
        return create_save_enabled_account_calendars_json_body
