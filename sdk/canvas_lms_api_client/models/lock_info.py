...
class LockInfo:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        manually_locked = self.manually_locked
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        context_module = d.pop("context_module")

        manually_locked = d.pop("manually_locked")
        ...
        lock_info.additional_properties = d
        return lock_info
