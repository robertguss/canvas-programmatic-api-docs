...
T = TypeVar("T", bound="UpdateDateDetailsJsonBody")


@_attrs_define
class UpdateDateDetailsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_date_details_json_body = cls(
            due_at=due_at,
            unlock_at=unlock_at,
            lock_at=lock_at,
        ...
        update_date_details_json_body.additional_properties = d
        return update_date_details_json_body
