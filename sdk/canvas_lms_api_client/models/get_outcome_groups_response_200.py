...
T = TypeVar("T", bound="GetOutcomeGroupsResponse200")


@_attrs_define
class GetOutcomeGroupsResponse200:
    """
    Attributes:
        id (int):
        url (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_outcome_groups_response_200 = cls(
            id=id,
            url=url,
            parent_outcome_group=parent_outcome_group,
            context_id=context_id,
        ...
        get_outcome_groups_response_200.additional_properties = d
        return get_outcome_groups_response_200
