...
T = TypeVar("T", bound="UpdateTermsDataBody")


@_attrs_define
class UpdateTermsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_terms_data_body.additional_properties = d
        return update_terms_data_body
