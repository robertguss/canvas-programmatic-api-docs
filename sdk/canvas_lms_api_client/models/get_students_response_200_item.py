...
T = TypeVar("T", bound="GetStudentsResponse200Item")


@_attrs_define
class GetStudentsResponse200Item:
    """
    Attributes:
        id (str):
        created_at (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_students_response_200_item = cls(
            id=id,
            created_at=created_at,
            event_type=event_type,
            excused_after=excused_after,
        ...
        get_students_response_200_item.additional_properties = d
        return get_students_response_200_item
