...
T = TypeVar("T", bound="HelpLinksCustomHelpLinksItem")


@_attrs_define
class HelpLinksCustomHelpLinksItem:
    """
    Attributes:
        id (str):
        text (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        help_links_custom_help_links_item = cls(
            id=id,
            text=text,
            subtext=subtext,
            url=url,
        ...
        help_links_custom_help_links_item.additional_properties = d
        return help_links_custom_help_links_item
