...
T = TypeVar("T", bound="CreateCoursesResponse200Permissions")


@_attrs_define
class CreateCoursesResponse200Permissions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_courses_response_200_permissions = cls(
            create_discussion_topic=create_discussion_topic,
            create_announcement=create_announcement,
        )

        create_courses_response_200_permissions.additional_properties = d
        return create_courses_response_200_permissions
