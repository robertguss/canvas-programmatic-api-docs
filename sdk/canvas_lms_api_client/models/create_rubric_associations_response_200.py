...
T = TypeVar("T", bound="CreateRubricAssociationsResponse200")


@_attrs_define
class CreateRubricAssociationsResponse200:
    """
    Attributes:
        id (int):
        rubric_id (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_rubric_associations_response_200 = cls(
            id=id,
            rubric_id=rubric_id,
            association_id=association_id,
            association_type=association_type,
        ...
        create_rubric_associations_response_200.additional_properties = d
        return create_rubric_associations_response_200
