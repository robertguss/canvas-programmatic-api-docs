...
T = TypeVar("T", bound="DeleteRubricAssessmentsResponse200")


@_attrs_define
class DeleteRubricAssessmentsResponse200:
    """
    Attributes:
        id (int):
        rubric_id (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_rubric_assessments_response_200 = cls(
            id=id,
            rubric_id=rubric_id,
            rubric_association_id=rubric_association_id,
            score=score,
        ...
        delete_rubric_assessments_response_200.additional_properties = d
        return delete_rubric_assessments_response_200
