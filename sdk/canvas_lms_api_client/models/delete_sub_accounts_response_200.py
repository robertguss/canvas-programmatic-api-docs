...
T = TypeVar("T", bound="DeleteSubAccountsResponse200")


@_attrs_define
class DeleteSubAccountsResponse200:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_sub_accounts_response_200 = cls(
            id=id,
            name=name,
            uuid=uuid,
            parent_account_id=parent_account_id,
        ...
        delete_sub_accounts_response_200.additional_properties = d
        return delete_sub_accounts_response_200
