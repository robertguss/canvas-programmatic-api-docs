...
T = TypeVar("T", bound="GetSubAccountsResponse200Item")


@_attrs_define
class GetSubAccountsResponse200Item:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_sub_accounts_response_200_item = cls(
            id=id,
            name=name,
            uuid=uuid,
            parent_account_id=parent_account_id,
        ...
        get_sub_accounts_response_200_item.additional_properties = d
        return get_sub_accounts_response_200_item
