...
T = TypeVar("T", bound="UpdateTokensJsonBody")


@_attrs_define
class UpdateTokensJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_tokens_json_body = cls(
            tokenexpires_at=tokenexpires_at,
            tokenscopes=tokenscopes,
        )

        update_tokens_json_body.additional_properties = d
        return update_tokens_json_body
