...
T = TypeVar("T", bound="UpdateOverridesDataBody")


@_attrs_define
class UpdateOverridesDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_overrides_data_body = cls(
        ...
        update_overrides_data_body.additional_properties = d
        return update_overrides_data_body
