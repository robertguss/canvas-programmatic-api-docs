...
T = TypeVar("T", bound="UpdatePollChoicesDataBody")


@_attrs_define
class UpdatePollChoicesDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_poll_choices_data_body = cls(
            poll_choicestext=poll_choicestext,
        )

        update_poll_choices_data_body.additional_properties = d
        return update_poll_choices_data_body
