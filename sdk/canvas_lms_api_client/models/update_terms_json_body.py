...
T = TypeVar("T", bound="UpdateTermsJsonBody")


@_attrs_define
class UpdateTermsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_terms_json_body.additional_properties = d
        return update_terms_json_body
