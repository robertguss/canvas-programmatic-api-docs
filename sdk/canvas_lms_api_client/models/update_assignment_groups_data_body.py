...
T = TypeVar("T", bound="UpdateAssignmentGroupsDataBody")


@_attrs_define
class UpdateAssignmentGroupsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_assignment_groups_data_body = cls(
            group_weight=group_weight,
            integration_data=integration_data,
        )

        update_assignment_groups_data_body.additional_properties = d
        return update_assignment_groups_data_body
