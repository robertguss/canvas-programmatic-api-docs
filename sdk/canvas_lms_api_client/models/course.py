...
if TYPE_CHECKING:
    from ..models.course_blueprint_restrictions import CourseBlueprintRestrictions
    from ..models.course_blueprint_restrictions_by_object_type import CourseBlueprintRestrictionsByObjectType
    from ..models.course_permissions import CoursePermissions
...
class Course:
    ...
    Attributes:
        ...
        time_zone (str):
        blueprint (bool):
        blueprint_restrictions (CourseBlueprintRestrictions):
        blueprint_restrictions_by_object_type (CourseBlueprintRestrictionsByObjectType):
        template (bool):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        permissions = CoursePermissions.from_dict(d.pop("permissions"))
        ...
        blueprint_restrictions = CourseBlueprintRestrictions.from_dict(d.pop("blueprint_restrictions"))

        blueprint_restrictions_by_object_type = CourseBlueprintRestrictionsByObjectType.from_dict(
