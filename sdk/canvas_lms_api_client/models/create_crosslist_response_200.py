...
T = TypeVar("T", bound="CreateCrosslistResponse200")


@_attrs_define
class CreateCrosslistResponse200:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_crosslist_response_200 = cls(
            id=id,
            name=name,
            sis_section_id=sis_section_id,
            integration_id=integration_id,
        ...
        create_crosslist_response_200.additional_properties = d
        return create_crosslist_response_200
