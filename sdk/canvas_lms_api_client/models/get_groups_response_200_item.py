...
if TYPE_CHECKING:
    from ..models.get_groups_response_200_item_permissions import GetGroupsResponse200ItemPermissions


T = TypeVar("T", bound="GetGroupsResponse200Item")


@_attrs_define
class GetGroupsResponse200Item:
    """
    Attributes:
        id (int):
        name (str):
        ...
        permissions (GetGroupsResponse200ItemPermissions):
        users (None):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        permissions = GetGroupsResponse200ItemPermissions.from_dict(d.pop("permissions"))

        users = d.pop("users")

        non_collaborative = d.pop("non_collaborative")

        get_groups_response_200_item = cls(
            id=id,
            name=name,
            description=description,
            is_public=is_public,
        ...
        get_groups_response_200_item.additional_properties = d
        return get_groups_response_200_item
