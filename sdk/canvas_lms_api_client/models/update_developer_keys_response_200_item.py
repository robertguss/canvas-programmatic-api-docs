...
if TYPE_CHECKING:
    from ..models.update_developer_keys_response_200_item_lti_registration import (
        UpdateDeveloperKeysResponse200ItemLtiRegistration,
    )
    from ..models.update_developer_keys_response_200_item_public_jwk import UpdateDeveloperKeysResponse200ItemPublicJwk
    from ..models.update_developer_keys_response_200_item_tool_configuration import (
        UpdateDeveloperKeysResponse200ItemToolConfiguration,
    )


T = TypeVar("T", bound="UpdateDeveloperKeysResponse200Item")


@_attrs_define
class UpdateDeveloperKeysResponse200Item:
    """
    Attributes:
        id (int):
        name (str):
        ...
        api_key (str):
        tool_configuration (UpdateDeveloperKeysResponse200ItemToolConfiguration):
        public_jwk (UpdateDeveloperKeysResponse200ItemPublicJwk):
        public_jwk_url (str):
        lti_registration (UpdateDeveloperKeysResponse200ItemLtiRegistration):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.update_developer_keys_response_200_item_public_jwk import (
        ...
        tool_configuration = UpdateDeveloperKeysResponse200ItemToolConfiguration.from_dict(d.pop("tool_configuration"))

        public_jwk = UpdateDeveloperKeysResponse200ItemPublicJwk.from_dict(d.pop("public_jwk"))

        public_jwk_url = d.pop("public_jwk_url")

        lti_registration = UpdateDeveloperKeysResponse200ItemLtiRegistration.from_dict(d.pop("lti_registration"))
        ...
        update_developer_keys_response_200_item = cls(
            id=id,
            name=name,
            created_at=created_at,
            updated_at=updated_at,
        ...
        update_developer_keys_response_200_item.additional_properties = d
        return update_developer_keys_response_200_item
