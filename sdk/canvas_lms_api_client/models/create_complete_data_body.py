...
T = TypeVar("T", bound="CreateCompleteDataBody")


@_attrs_define
class CreateCompleteDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_complete_data_body = cls(
            attempt=attempt,
            validation_token=validation_token,
        )

        create_complete_data_body.additional_properties = d
        return create_complete_data_body
