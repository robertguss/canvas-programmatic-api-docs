...
T = TypeVar("T", bound="GetAuthenticationProvidersResponse200")


@_attrs_define
class GetAuthenticationProvidersResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_authentication_providers_response_200 = cls(
            identifier_format=identifier_format,
            auth_type=auth_type,
            id=id,
            log_out_url=log_out_url,
        ...
        get_authentication_providers_response_200.additional_properties = d
        return get_authentication_providers_response_200
