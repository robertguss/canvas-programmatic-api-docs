...
T = TypeVar("T", bound="CreateInviteDataBody")


@_attrs_define
class CreateInviteDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_invite_data_body = cls(
            invitees=invitees,
        )

        create_invite_data_body.additional_properties = d
        return create_invite_data_body
