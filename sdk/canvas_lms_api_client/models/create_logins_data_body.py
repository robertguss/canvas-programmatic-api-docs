...
T = TypeVar("T", bound="CreateLoginsDataBody")


@_attrs_define
class CreateLoginsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_logins_data_body = cls(
            userid=userid,
            loginunique_id=loginunique_id,
        )

        create_logins_data_body.additional_properties = d
        return create_logins_data_body
