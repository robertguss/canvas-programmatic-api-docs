...
T = TypeVar("T", bound="GetGroupsResponse200ItemPermissions")


@_attrs_define
class GetGroupsResponse200ItemPermissions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_groups_response_200_item_permissions = cls(
            create_discussion_topic=create_discussion_topic,
            create_announcement=create_announcement,
        )

        get_groups_response_200_item_permissions.additional_properties = d
        return get_groups_response_200_item_permissions
