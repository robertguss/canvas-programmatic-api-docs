...
T = TypeVar("T", bound="GetMediaResponse200")


@_attrs_define
class GetMediaResponse200:
    """
    Attributes:
        context_type (str):
        context_id (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_media_response_200.additional_properties = d
        return get_media_response_200
