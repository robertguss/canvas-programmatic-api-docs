...
T = TypeVar("T", bound="GetItemsResponse200Item")


@_attrs_define
class GetItemsResponse200Item:
    """
    Attributes:
        id (str):
        position (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_items_response_200_item = cls(
            id=id,
            position=position,
            points_possible=points_possible,
            entry_type=entry_type,
        ...
        get_items_response_200_item.additional_properties = d
        return get_items_response_200_item
