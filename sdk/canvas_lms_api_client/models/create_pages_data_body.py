...
T = TypeVar("T", bound="CreatePagesDataBody")


@_attrs_define
class CreatePagesDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_pages_data_body = cls(
            wiki_pagetitle=wiki_pagetitle,
            wiki_pagepublish_at=wiki_pagepublish_at,
        )

        create_pages_data_body.additional_properties = d
        return create_pages_data_body
