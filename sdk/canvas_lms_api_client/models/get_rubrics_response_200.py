...
T = TypeVar("T", bound="GetRubricsResponse200")


@_attrs_define
class GetRubricsResponse200:
    """
    Attributes:
        id (int):
        title (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_rubrics_response_200.additional_properties = d
        return get_rubrics_response_200
