...
T = TypeVar("T", bound="CreateSubgroupsResponse200")


@_attrs_define
class CreateSubgroupsResponse200:
    """
    Attributes:
        id (int):
        url (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_subgroups_response_200 = cls(
            id=id,
            url=url,
            parent_outcome_group=parent_outcome_group,
            context_id=context_id,
        ...
        create_subgroups_response_200.additional_properties = d
        return create_subgroups_response_200
