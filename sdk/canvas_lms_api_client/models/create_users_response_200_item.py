...
T = TypeVar("T", bound="CreateUsersResponse200Item")


@_attrs_define
class CreateUsersResponse200Item:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_users_response_200_item = cls(
            id=id,
            name=name,
            sortable_name=sortable_name,
            last_name=last_name,
        ...
        create_users_response_200_item.additional_properties = d
        return create_users_response_200_item
