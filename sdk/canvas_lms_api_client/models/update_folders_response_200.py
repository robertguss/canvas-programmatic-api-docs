...
T = TypeVar("T", bound="UpdateFoldersResponse200")


@_attrs_define
class UpdateFoldersResponse200:
    """
    Attributes:
        context_type (str):
        context_id (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_folders_response_200 = cls(
            context_type=context_type,
            context_id=context_id,
            files_count=files_count,
            position=position,
        ...
        update_folders_response_200.additional_properties = d
        return update_folders_response_200
