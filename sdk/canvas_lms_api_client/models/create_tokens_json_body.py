...
T = TypeVar("T", bound="CreateTokensJsonBody")


@_attrs_define
class CreateTokensJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_tokens_json_body = cls(
            tokenpurpose=tokenpurpose,
            tokenexpires_at=tokenexpires_at,
            tokenscopes=tokenscopes,
        )

        create_tokens_json_body.additional_properties = d
        return create_tokens_json_body
