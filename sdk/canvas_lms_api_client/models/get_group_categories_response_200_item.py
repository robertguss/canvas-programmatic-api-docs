...
T = TypeVar("T", bound="GetGroupCategoriesResponse200Item")


@_attrs_define
class GetGroupCategoriesResponse200Item:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_group_categories_response_200_item = cls(
            id=id,
            name=name,
            role=role,
            self_signup=self_signup,
        ...
        get_group_categories_response_200_item.additional_properties = d
        return get_group_categories_response_200_item
