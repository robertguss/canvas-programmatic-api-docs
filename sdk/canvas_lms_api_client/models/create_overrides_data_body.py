...
T = TypeVar("T", bound="CreateOverridesDataBody")


@_attrs_define
class CreateOverridesDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_overrides_data_body = cls(
        ...
        create_overrides_data_body.additional_properties = d
        return create_overrides_data_body
