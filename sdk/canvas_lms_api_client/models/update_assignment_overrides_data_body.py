...
T = TypeVar("T", bound="UpdateAssignmentOverridesDataBody")


@_attrs_define
class UpdateAssignmentOverridesDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_assignment_overrides_data_body = cls(
            overrides=overrides,
        )

        update_assignment_overrides_data_body.additional_properties = d
        return update_assignment_overrides_data_body
