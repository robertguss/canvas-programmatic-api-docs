...
T = TypeVar("T", bound="CreateScoresJsonBody")


@_attrs_define
class CreateScoresJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_scores_json_body.additional_properties = d
        return create_scores_json_body
