...
T = TypeVar("T", bound="UpdateGradingPeriodsJsonBody")


@_attrs_define
class UpdateGradingPeriodsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_grading_periods_json_body = cls(
        ...
        update_grading_periods_json_body.additional_properties = d
        return update_grading_periods_json_body
