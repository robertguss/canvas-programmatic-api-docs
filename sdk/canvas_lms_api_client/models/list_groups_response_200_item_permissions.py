...
T = TypeVar("T", bound="ListGroupsResponse200ItemPermissions")


@_attrs_define
class ListGroupsResponse200ItemPermissions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_groups_response_200_item_permissions = cls(
            create_discussion_topic=create_discussion_topic,
            create_announcement=create_announcement,
        )

        list_groups_response_200_item_permissions.additional_properties = d
        return list_groups_response_200_item_permissions
