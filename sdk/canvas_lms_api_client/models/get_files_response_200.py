...
T = TypeVar("T", bound="GetFilesResponse200")


@_attrs_define
class GetFilesResponse200:
    """
    Attributes:
        id (int):
        uuid (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_files_response_200.additional_properties = d
        return get_files_response_200
