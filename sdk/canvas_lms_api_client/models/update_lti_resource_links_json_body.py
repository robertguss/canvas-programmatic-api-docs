...
T = TypeVar("T", bound="UpdateLtiResourceLinksJsonBody")


@_attrs_define
class UpdateLtiResourceLinksJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_lti_resource_links_json_body = cls(
            custom=custom,
        )

        update_lti_resource_links_json_body.additional_properties = d
        return update_lti_resource_links_json_body
