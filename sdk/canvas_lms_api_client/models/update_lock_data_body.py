...
T = TypeVar("T", bound="UpdateLockDataBody")


@_attrs_define
class UpdateLockDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_lock_data_body = cls(
            settings_locked=settings_locked,
        )

        update_lock_data_body.additional_properties = d
        return update_lock_data_body
