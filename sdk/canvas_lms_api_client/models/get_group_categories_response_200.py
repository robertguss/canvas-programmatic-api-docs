...
T = TypeVar("T", bound="GetGroupCategoriesResponse200")


@_attrs_define
class GetGroupCategoriesResponse200:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_group_categories_response_200 = cls(
            id=id,
            name=name,
            role=role,
            self_signup=self_signup,
        ...
        get_group_categories_response_200.additional_properties = d
        return get_group_categories_response_200
