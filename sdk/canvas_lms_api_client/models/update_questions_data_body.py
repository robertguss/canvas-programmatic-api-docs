...
T = TypeVar("T", bound="UpdateQuestionsDataBody")


@_attrs_define
class UpdateQuestionsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_questions_data_body = cls(
            quiz_id=quiz_id,
            id=id,
            questionanswers=questionanswers,
        )

        update_questions_data_body.additional_properties = d
        return update_questions_data_body
