...
T = TypeVar("T", bound="ListAccountCalendarsResponse200Item")


@_attrs_define
class ListAccountCalendarsResponse200Item:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_account_calendars_response_200_item = cls(
            id=id,
            name=name,
            parent_account_id=parent_account_id,
            root_account_id=root_account_id,
        ...
        list_account_calendars_response_200_item.additional_properties = d
        return list_account_calendars_response_200_item
