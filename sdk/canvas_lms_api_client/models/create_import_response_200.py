...
T = TypeVar("T", bound="CreateImportResponse200")


@_attrs_define
class CreateImportResponse200:
    """
    Attributes:
        id (int):
        url (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_import_response_200 = cls(
            id=id,
            url=url,
            parent_outcome_group=parent_outcome_group,
            context_id=context_id,
        ...
        create_import_response_200.additional_properties = d
        return create_import_response_200
