...
T = TypeVar("T", bound="GetSectionsResponse200")


@_attrs_define
class GetSectionsResponse200:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_sections_response_200.additional_properties = d
        return get_sections_response_200
