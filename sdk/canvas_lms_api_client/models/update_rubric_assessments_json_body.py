...
T = TypeVar("T", bound="UpdateRubricAssessmentsJsonBody")


@_attrs_define
class UpdateRubricAssessmentsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_rubric_assessments_json_body = cls(
            rubric_assessment=rubric_assessment,
        )

        update_rubric_assessments_json_body.additional_properties = d
        return update_rubric_assessments_json_body
