...
T = TypeVar("T", bound="UpdateOverridesJsonBody")


@_attrs_define
class UpdateOverridesJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_overrides_json_body = cls(
        ...
        update_overrides_json_body.additional_properties = d
        return update_overrides_json_body
