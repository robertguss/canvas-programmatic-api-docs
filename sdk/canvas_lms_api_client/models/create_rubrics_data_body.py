...
T = TypeVar("T", bound="CreateRubricsDataBody")


@_attrs_define
class CreateRubricsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_rubrics_data_body = cls(
            rubriccriteria=rubriccriteria,
        )

        create_rubrics_data_body.additional_properties = d
        return create_rubrics_data_body
