...
T = TypeVar("T", bound="CreateOriginalityReportResponse200")


@_attrs_define
class CreateOriginalityReportResponse200:
    """
    Attributes:
        id (int):
        file_id (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_originality_report_response_200 = cls(
            id=id,
            file_id=file_id,
            originality_score=originality_score,
            originality_report_file_id=originality_report_file_id,
        ...
        create_originality_report_response_200.additional_properties = d
        return create_originality_report_response_200
