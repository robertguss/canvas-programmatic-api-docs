...
if TYPE_CHECKING:
    from ..models.get_enrollments_response_200_grades import GetEnrollmentsResponse200Grades
    from ..models.get_enrollments_response_200_user import GetEnrollmentsResponse200User


T = TypeVar("T", bound="GetEnrollmentsResponse200")


@_attrs_define
class GetEnrollmentsResponse200:
    """
    Attributes:
        id (int):
        course_id (int):
        ...
        html_url (str):
        grades (GetEnrollmentsResponse200Grades):
        user (GetEnrollmentsResponse200User):
        override_grade (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        grades = GetEnrollmentsResponse200Grades.from_dict(d.pop("grades"))

        user = GetEnrollmentsResponse200User.from_dict(d.pop("user"))
        ...
        get_enrollments_response_200 = cls(
            id=id,
            course_id=course_id,
            sis_course_id=sis_course_id,
            course_integration_id=course_integration_id,
        ...
        get_enrollments_response_200.additional_properties = d
        return get_enrollments_response_200
