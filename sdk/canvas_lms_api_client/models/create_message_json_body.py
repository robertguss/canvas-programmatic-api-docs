...
T = TypeVar("T", bound="CreateMessageJsonBody")


@_attrs_define
class CreateMessageJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_message_json_body = cls(
            conversations=conversations,
        )

        create_message_json_body.additional_properties = d
        return create_message_json_body
