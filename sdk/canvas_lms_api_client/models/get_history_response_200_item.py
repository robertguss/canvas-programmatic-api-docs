...
T = TypeVar("T", bound="GetHistoryResponse200Item")


@_attrs_define
class GetHistoryResponse200Item:
    """
    Attributes:
        asset_code (str):
        asset_name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_history_response_200_item = cls(
            asset_code=asset_code,
            asset_name=asset_name,
            asset_icon=asset_icon,
            asset_readable_category=asset_readable_category,
        ...
        get_history_response_200_item.additional_properties = d
        return get_history_response_200_item
