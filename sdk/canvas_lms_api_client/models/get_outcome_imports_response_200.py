...
T = TypeVar("T", bound="GetOutcomeImportsResponse200")


@_attrs_define
class GetOutcomeImportsResponse200:
    """
    Attributes:
        id (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_outcome_imports_response_200 = cls(
            id=id,
            learning_outcome_group_id=learning_outcome_group_id,
            created_at=created_at,
            ended_at=ended_at,
        ...
        get_outcome_imports_response_200.additional_properties = d
        return get_outcome_imports_response_200
