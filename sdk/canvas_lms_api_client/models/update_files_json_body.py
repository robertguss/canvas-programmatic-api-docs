...
T = TypeVar("T", bound="UpdateFilesJsonBody")


@_attrs_define
class UpdateFilesJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_files_json_body = cls(
            lock_at=lock_at,
            unlock_at=unlock_at,
        )

        update_files_json_body.additional_properties = d
        return update_files_json_body
