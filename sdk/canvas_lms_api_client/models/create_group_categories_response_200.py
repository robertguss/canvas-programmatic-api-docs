...
T = TypeVar("T", bound="CreateGroupCategoriesResponse200")


@_attrs_define
class CreateGroupCategoriesResponse200:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_group_categories_response_200 = cls(
            id=id,
            name=name,
            role=role,
            self_signup=self_signup,
        ...
        create_group_categories_response_200.additional_properties = d
        return create_group_categories_response_200
