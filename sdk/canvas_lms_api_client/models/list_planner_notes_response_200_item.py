...
T = TypeVar("T", bound="ListPlannerNotesResponse200Item")


@_attrs_define
class ListPlannerNotesResponse200Item:
    """
    Attributes:
        id (int):
        title (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_planner_notes_response_200_item = cls(
            id=id,
            title=title,
            description=description,
            user_id=user_id,
        ...
        list_planner_notes_response_200_item.additional_properties = d
        return list_planner_notes_response_200_item
