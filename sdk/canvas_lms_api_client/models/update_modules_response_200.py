...
T = TypeVar("T", bound="UpdateModulesResponse200")


@_attrs_define
class UpdateModulesResponse200:
    """
    Attributes:
        id (int):
        workflow_state (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_modules_response_200 = cls(
            id=id,
            workflow_state=workflow_state,
            position=position,
            name=name,
        ...
        update_modules_response_200.additional_properties = d
        return update_modules_response_200
