...
T = TypeVar("T", bound="CreateSubmissionsJsonBody")


@_attrs_define
class CreateSubmissionsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_submissions_json_body = cls(
            submissionsubmission_type=submissionsubmission_type,
            submissionsubmitted_at=submissionsubmitted_at,
        )

        create_submissions_json_body.additional_properties = d
        return create_submissions_json_body
