...
T = TypeVar("T", bound="ListCourseCreationAccountsResponse200Item")


@_attrs_define
class ListCourseCreationAccountsResponse200Item:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_course_creation_accounts_response_200_item = cls(
            id=id,
            name=name,
            uuid=uuid,
            parent_account_id=parent_account_id,
        ...
        list_course_creation_accounts_response_200_item.additional_properties = d
        return list_course_creation_accounts_response_200_item
