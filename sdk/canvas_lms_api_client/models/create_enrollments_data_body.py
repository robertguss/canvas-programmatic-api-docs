...
T = TypeVar("T", bound="CreateEnrollmentsDataBody")


@_attrs_define
class CreateEnrollmentsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_enrollments_data_body = cls(
        ...
        create_enrollments_data_body.additional_properties = d
        return create_enrollments_data_body
