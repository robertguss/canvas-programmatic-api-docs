...
T = TypeVar("T", bound="UpdateGradingStandardsDataBody")


@_attrs_define
class UpdateGradingStandardsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_grading_standards_data_body = cls(
            grading_scheme_entryvalue=grading_scheme_entryvalue,
        )

        update_grading_standards_data_body.additional_properties = d
        return update_grading_standards_data_body
