...
T = TypeVar("T", bound="DeleteSectionsResponse200")


@_attrs_define
class DeleteSectionsResponse200:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_sections_response_200 = cls(
            id=id,
            name=name,
            sis_section_id=sis_section_id,
            integration_id=integration_id,
        ...
        delete_sections_response_200.additional_properties = d
        return delete_sections_response_200
