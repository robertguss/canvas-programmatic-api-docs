...
T = TypeVar("T", bound="UpdatePlannerNotesDataBody")


@_attrs_define
class UpdatePlannerNotesDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_planner_notes_data_body = cls(
            todo_date=todo_date,
        )

        update_planner_notes_data_body.additional_properties = d
        return update_planner_notes_data_body
