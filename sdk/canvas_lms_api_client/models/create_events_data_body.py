...
T = TypeVar("T", bound="CreateEventsDataBody")


@_attrs_define
class CreateEventsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_events_data_body = cls(
            quiz_submission_events=quiz_submission_events,
        )

        create_events_data_body.additional_properties = d
        return create_events_data_body
