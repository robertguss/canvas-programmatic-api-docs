...
T = TypeVar("T", bound="UpdateOverridesResponse200")


@_attrs_define
class UpdateOverridesResponse200:
    """
    Attributes:
        id (int):
        assignment_id (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_overrides_response_200 = cls(
            id=id,
            assignment_id=assignment_id,
            quiz_id=quiz_id,
            context_module_id=context_module_id,
        ...
        update_overrides_response_200.additional_properties = d
        return update_overrides_response_200
