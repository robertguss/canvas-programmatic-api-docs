...
T = TypeVar("T", bound="UpdateGradingPeriodSetsDataBody")


@_attrs_define
class UpdateGradingPeriodSetsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_grading_period_sets_data_body = cls(
            enrollment_term_ids=enrollment_term_ids,
            grading_period_settitle=grading_period_settitle,
        )

        update_grading_period_sets_data_body.additional_properties = d
        return update_grading_period_sets_data_body
