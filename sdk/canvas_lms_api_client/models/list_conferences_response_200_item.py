...
if TYPE_CHECKING:
    from ..models.list_conferences_response_200_item_user_settings import ListConferencesResponse200ItemUserSettings


T = TypeVar("T", bound="ListConferencesResponse200Item")


@_attrs_define
class ListConferencesResponse200Item:
    """
    Attributes:
        id (int):
        conference_type (str):
        ...
        long_running (bool):
        user_settings (ListConferencesResponse200ItemUserSettings):
        recordings (None):
        url (None):
        join_url (None):
        context_type (None):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_settings = ListConferencesResponse200ItemUserSettings.from_dict(d.pop("user_settings"))
        ...
        list_conferences_response_200_item = cls(
            id=id,
            conference_type=conference_type,
            conference_key=conference_key,
            description=description,
        ...
        list_conferences_response_200_item.additional_properties = d
        return list_conferences_response_200_item
