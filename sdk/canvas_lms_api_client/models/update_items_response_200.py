...
T = TypeVar("T", bound="UpdateItemsResponse200")


@_attrs_define
class UpdateItemsResponse200:
    """
    Attributes:
        id (str):
        position (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_items_response_200.additional_properties = d
        return update_items_response_200
