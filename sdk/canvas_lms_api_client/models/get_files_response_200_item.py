...
T = TypeVar("T", bound="GetFilesResponse200Item")


@_attrs_define
class GetFilesResponse200Item:
    """
    Attributes:
        id (int):
        uuid (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_files_response_200_item = cls(
            id=id,
            uuid=uuid,
            folder_id=folder_id,
            display_name=display_name,
        ...
        get_files_response_200_item.additional_properties = d
        return get_files_response_200_item
