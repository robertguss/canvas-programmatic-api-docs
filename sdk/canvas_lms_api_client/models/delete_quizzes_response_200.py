...
T = TypeVar("T", bound="DeleteQuizzesResponse200")


@_attrs_define
class DeleteQuizzesResponse200:
    """
    Attributes:
        id (str):
        title (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_quizzes_response_200 = cls(
            id=id,
            title=title,
            instructions=instructions,
            assignment_group_id=assignment_group_id,
        ...
        delete_quizzes_response_200.additional_properties = d
        return delete_quizzes_response_200
