...
T = TypeVar("T", bound="DeleteModulesResponse200")


@_attrs_define
class DeleteModulesResponse200:
    """
    Attributes:
        id (int):
        workflow_state (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_modules_response_200 = cls(
            id=id,
            workflow_state=workflow_state,
            position=position,
            name=name,
        ...
        delete_modules_response_200.additional_properties = d
        return delete_modules_response_200
