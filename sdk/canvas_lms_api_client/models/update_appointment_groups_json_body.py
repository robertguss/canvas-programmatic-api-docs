...
T = TypeVar("T", bound="UpdateAppointmentGroupsJsonBody")


@_attrs_define
class UpdateAppointmentGroupsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_appointment_groups_json_body = cls(
            appointment_groupcontext_codes=appointment_groupcontext_codes,
        )

        update_appointment_groups_json_body.additional_properties = d
        return update_appointment_groups_json_body
