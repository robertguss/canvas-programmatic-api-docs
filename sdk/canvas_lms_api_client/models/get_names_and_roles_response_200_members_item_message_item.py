...
if TYPE_CHECKING:
    from ..models.get_names_and_roles_response_200_members_item_message_item_httpspurl_imsglobal_orgspeclticlaimcustom import (
        GetNamesAndRolesResponse200MembersItemMessageItemHttpspurlImsglobalOrgspeclticlaimcustom,
    )


T = TypeVar("T", bound="GetNamesAndRolesResponse200MembersItemMessageItem")


@_attrs_define
class GetNamesAndRolesResponse200MembersItemMessageItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        httpspurl_imsglobal_orgspeclticlaimcustom = (
            GetNamesAndRolesResponse200MembersItemMessageItemHttpspurlImsglobalOrgspeclticlaimcustom.from_dict(
                d.pop("https://purl.imsglobal.org/spec/lti/claim/custom")
            )
        )

        get_names_and_roles_response_200_members_item_message_item = cls(
        ...
        get_names_and_roles_response_200_members_item_message_item.additional_properties = d
        return get_names_and_roles_response_200_members_item_message_item
