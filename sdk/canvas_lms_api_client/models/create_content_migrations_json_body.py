...
T = TypeVar("T", bound="CreateContentMigrationsJsonBody")


@_attrs_define
class CreateContentMigrationsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_content_migrations_json_body = cls(
            select=select,
        ...
        create_content_migrations_json_body.additional_properties = d
        return create_content_migrations_json_body
