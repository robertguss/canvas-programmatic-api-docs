...
T = TypeVar("T", bound="UpdatePlannerNotesJsonBody")


@_attrs_define
class UpdatePlannerNotesJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_planner_notes_json_body = cls(
            todo_date=todo_date,
        )

        update_planner_notes_json_body.additional_properties = d
        return update_planner_notes_json_body
