...
T = TypeVar("T", bound="CreateResetVerifierResponse200")


@_attrs_define
class CreateResetVerifierResponse200:
    """
    Attributes:
        id (int):
        uuid (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_reset_verifier_response_200 = cls(
            id=id,
            uuid=uuid,
            folder_id=folder_id,
            display_name=display_name,
        ...
        create_reset_verifier_response_200.additional_properties = d
        return create_reset_verifier_response_200
