...
T = TypeVar("T", bound="CreateContentSharesJsonBody")


@_attrs_define
class CreateContentSharesJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_content_shares_json_body = cls(
            receiver_ids=receiver_ids,
            content_type=content_type,
            content_id=content_id,
        )

        create_content_shares_json_body.additional_properties = d
        return create_content_shares_json_body
