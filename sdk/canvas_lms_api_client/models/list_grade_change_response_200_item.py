...
T = TypeVar("T", bound="ListGradeChangeResponse200Item")


@_attrs_define
class ListGradeChangeResponse200Item:
    """
    Attributes:
        id (str):
        created_at (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_grade_change_response_200_item = cls(
            id=id,
            created_at=created_at,
            event_type=event_type,
            excused_after=excused_after,
        ...
        list_grade_change_response_200_item.additional_properties = d
        return list_grade_change_response_200_item
