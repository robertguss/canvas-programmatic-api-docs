...
T = TypeVar("T", bound="CreateQuizzesResponse200")


@_attrs_define
class CreateQuizzesResponse200:
    """
    Attributes:
        id (str):
        title (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_quizzes_response_200 = cls(
            id=id,
            title=title,
            instructions=instructions,
            assignment_group_id=assignment_group_id,
        ...
        create_quizzes_response_200.additional_properties = d
        return create_quizzes_response_200
