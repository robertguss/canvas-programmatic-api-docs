...
T = TypeVar("T", bound="UpdateWhatIfGradesJsonBody")


@_attrs_define
class UpdateWhatIfGradesJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_what_if_grades_json_body = cls(
            student_entered_score=student_entered_score,
        )

        update_what_if_grades_json_body.additional_properties = d
        return update_what_if_grades_json_body
