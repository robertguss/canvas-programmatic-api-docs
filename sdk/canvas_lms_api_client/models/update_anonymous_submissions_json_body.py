...
T = TypeVar("T", bound="UpdateAnonymousSubmissionsJsonBody")


@_attrs_define
class UpdateAnonymousSubmissionsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_anonymous_submissions_json_body = cls(
            rubric_assessment=rubric_assessment,
        )

        update_anonymous_submissions_json_body.additional_properties = d
        return update_anonymous_submissions_json_body
