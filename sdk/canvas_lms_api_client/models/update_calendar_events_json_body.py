...
T = TypeVar("T", bound="UpdateCalendarEventsJsonBody")


@_attrs_define
class UpdateCalendarEventsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_calendar_events_json_body = cls(
        ...
        update_calendar_events_json_body.additional_properties = d
        return update_calendar_events_json_body
