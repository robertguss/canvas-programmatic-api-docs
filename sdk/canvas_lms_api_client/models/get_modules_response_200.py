...
T = TypeVar("T", bound="GetModulesResponse200")


@_attrs_define
class GetModulesResponse200:
    """
    Attributes:
        id (int):
        workflow_state (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_modules_response_200.additional_properties = d
        return get_modules_response_200
