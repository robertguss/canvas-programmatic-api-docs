...
T = TypeVar("T", bound="CreateLineItemsDataBody")


@_attrs_define
class CreateLineItemsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_line_items_data_body = cls(
            score_maximum=score_maximum,
            label=label,
            httpscanvas_instructure_comltisubmission_type=httpscanvas_instructure_comltisubmission_type,
        )

        create_line_items_data_body.additional_properties = d
        return create_line_items_data_body
