...
T = TypeVar("T", bound="UpdatePollChoicesJsonBody")


@_attrs_define
class UpdatePollChoicesJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_poll_choices_json_body = cls(
            poll_choicestext=poll_choicestext,
        )

        update_poll_choices_json_body.additional_properties = d
        return update_poll_choices_json_body
