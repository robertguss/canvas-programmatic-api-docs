...
T = TypeVar("T", bound="UpdateSectionsResponse200")


@_attrs_define
class UpdateSectionsResponse200:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_sections_response_200 = cls(
            id=id,
            name=name,
            sis_section_id=sis_section_id,
            integration_id=integration_id,
        ...
        update_sections_response_200.additional_properties = d
        return update_sections_response_200
