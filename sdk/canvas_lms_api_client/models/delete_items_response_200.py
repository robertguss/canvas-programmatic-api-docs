...
T = TypeVar("T", bound="DeleteItemsResponse200")


@_attrs_define
class DeleteItemsResponse200:
    """
    Attributes:
        id (str):
        position (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_items_response_200.additional_properties = d
        return delete_items_response_200
