...
T = TypeVar("T", bound="LearningObjectDates")


@_attrs_define
class LearningObjectDates:
    """
    Attributes:
        id (int):
        due_at (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        learning_object_dates.additional_properties = d
        return learning_object_dates
