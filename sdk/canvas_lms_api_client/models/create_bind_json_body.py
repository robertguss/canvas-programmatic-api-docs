...
T = TypeVar("T", bound="CreateBindJsonBody")


@_attrs_define
class CreateBindJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_bind_json_body = cls(
            workflow_state=workflow_state,
        )

        create_bind_json_body.additional_properties = d
        return create_bind_json_body
