...
T = TypeVar("T", bound="CreateDeveloperKeysJsonBody")


@_attrs_define
class CreateDeveloperKeysJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_developer_keys_json_body = cls(
            developer_key=developer_key,
            developer_keyredirect_uris=developer_keyredirect_uris,
            developer_keyscopes=developer_keyscopes,
        )

        create_developer_keys_json_body.additional_properties = d
        return create_developer_keys_json_body
