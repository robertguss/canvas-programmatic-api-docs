...
T = TypeVar("T", bound="CreateCopyFileJsonBody")


@_attrs_define
class CreateCopyFileJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_copy_file_json_body = cls(
            source_file_id=source_file_id,
        )

        create_copy_file_json_body.additional_properties = d
        return create_copy_file_json_body
