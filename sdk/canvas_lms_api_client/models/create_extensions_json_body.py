...
T = TypeVar("T", bound="CreateExtensionsJsonBody")


@_attrs_define
class CreateExtensionsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_extensions_json_body = cls(
        ...
        create_extensions_json_body.additional_properties = d
        return create_extensions_json_body
