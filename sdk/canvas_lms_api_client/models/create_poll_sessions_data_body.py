...
T = TypeVar("T", bound="CreatePollSessionsDataBody")


@_attrs_define
class CreatePollSessionsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_poll_sessions_data_body = cls(
            poll_sessionscourse_id=poll_sessionscourse_id,
        )

        create_poll_sessions_data_body.additional_properties = d
        return create_poll_sessions_data_body
