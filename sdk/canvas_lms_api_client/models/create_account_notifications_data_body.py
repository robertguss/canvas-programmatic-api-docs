...
T = TypeVar("T", bound="CreateAccountNotificationsDataBody")


@_attrs_define
class CreateAccountNotificationsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_account_notifications_data_body = cls(
        ...
        create_account_notifications_data_body.additional_properties = d
        return create_account_notifications_data_body
