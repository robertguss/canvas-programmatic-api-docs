...
T = TypeVar("T", bound="CreateRubricsJsonBody")


@_attrs_define
class CreateRubricsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_rubrics_json_body = cls(
            rubriccriteria=rubriccriteria,
        )

        create_rubrics_json_body.additional_properties = d
        return create_rubrics_json_body
