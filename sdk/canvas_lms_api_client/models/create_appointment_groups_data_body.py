...
T = TypeVar("T", bound="CreateAppointmentGroupsDataBody")


@_attrs_define
class CreateAppointmentGroupsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_appointment_groups_data_body = cls(
            appointment_groupcontext_codes=appointment_groupcontext_codes,
            appointment_grouptitle=appointment_grouptitle,
        )

        create_appointment_groups_data_body.additional_properties = d
        return create_appointment_groups_data_body
