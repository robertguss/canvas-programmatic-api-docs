...
T = TypeVar("T", bound="CreateTimetableJsonBody")


@_attrs_define
class CreateTimetableJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_timetable_json_body = cls(
            timetablescourse_section_id=timetablescourse_section_id,
        )

        create_timetable_json_body.additional_properties = d
        return create_timetable_json_body
