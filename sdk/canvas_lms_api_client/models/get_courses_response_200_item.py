...
if TYPE_CHECKING:
    from ..models.get_courses_response_200_item_blueprint_restrictions import (
        GetCoursesResponse200ItemBlueprintRestrictions,
    )
    from ..models.get_courses_response_200_item_blueprint_restrictions_by_object_type import (
        GetCoursesResponse200ItemBlueprintRestrictionsByObjectType,
    )
    from ..models.get_courses_response_200_item_permissions import GetCoursesResponse200ItemPermissions


T = TypeVar("T", bound="GetCoursesResponse200Item")


@_attrs_define
class GetCoursesResponse200Item:
    """
    Attributes:
        id (int):
        sis_course_id (None):
        ...
        permissions (GetCoursesResponse200ItemPermissions):
        is_public (bool):
        ...
        time_zone (str):
        blueprint (bool):
        blueprint_restrictions (GetCoursesResponse200ItemBlueprintRestrictions):
        blueprint_restrictions_by_object_type (GetCoursesResponse200ItemBlueprintRestrictionsByObjectType):
        template (bool):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        permissions = GetCoursesResponse200ItemPermissions.from_dict(d.pop("permissions"))
        ...
        blueprint_restrictions = GetCoursesResponse200ItemBlueprintRestrictions.from_dict(
            d.pop("blueprint_restrictions")
        )

        blueprint_restrictions_by_object_type = GetCoursesResponse200ItemBlueprintRestrictionsByObjectType.from_dict(
            d.pop("blueprint_restrictions_by_object_type")
        )

        template = d.pop("template")

        get_courses_response_200_item = cls(
            id=id,
            sis_course_id=sis_course_id,
            uuid=uuid,
            integration_id=integration_id,
        ...
        get_courses_response_200_item.additional_properties = d
        return get_courses_response_200_item
