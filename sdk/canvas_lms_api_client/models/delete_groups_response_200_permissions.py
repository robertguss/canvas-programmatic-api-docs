...
T = TypeVar("T", bound="DeleteGroupsResponse200Permissions")


@_attrs_define
class DeleteGroupsResponse200Permissions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_groups_response_200_permissions = cls(
            create_discussion_topic=create_discussion_topic,
            create_announcement=create_announcement,
        )

        delete_groups_response_200_permissions.additional_properties = d
        return delete_groups_response_200_permissions
