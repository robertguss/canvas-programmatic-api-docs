...
T = TypeVar("T", bound="CreateUpdateGradesJsonBody")


@_attrs_define
class CreateUpdateGradesJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_update_grades_json_body = cls(
            grade_datastudent_idrubric_assessment=grade_datastudent_idrubric_assessment,
        )

        create_update_grades_json_body.additional_properties = d
        return create_update_grades_json_body
