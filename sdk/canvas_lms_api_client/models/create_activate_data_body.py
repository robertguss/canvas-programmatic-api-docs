...
T = TypeVar("T", bound="CreateActivateDataBody")


@_attrs_define
class CreateActivateDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_activate_data_body = cls(
            role_id=role_id,
            role=role,
        )

        create_activate_data_body.additional_properties = d
        return create_activate_data_body
