...
T = TypeVar("T", bound="UpdateAccountNotificationsJsonBody")


@_attrs_define
class UpdateAccountNotificationsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_account_notifications_json_body = cls(
            account_notificationstart_at=account_notificationstart_at,
            account_notificationend_at=account_notificationend_at,
        )

        update_account_notifications_json_body.additional_properties = d
        return update_account_notifications_json_body
