...
if TYPE_CHECKING:
    from ..models.get_developer_keys_response_200_item_lti_registration import (
        GetDeveloperKeysResponse200ItemLtiRegistration,
    )
    from ..models.get_developer_keys_response_200_item_public_jwk import GetDeveloperKeysResponse200ItemPublicJwk
    from ..models.get_developer_keys_response_200_item_tool_configuration import (
        GetDeveloperKeysResponse200ItemToolConfiguration,
    )


T = TypeVar("T", bound="GetDeveloperKeysResponse200Item")


@_attrs_define
class GetDeveloperKeysResponse200Item:
    """
    Attributes:
        id (int):
        name (str):
        ...
        api_key (str):
        tool_configuration (GetDeveloperKeysResponse200ItemToolConfiguration):
        public_jwk (GetDeveloperKeysResponse200ItemPublicJwk):
        public_jwk_url (str):
        lti_registration (GetDeveloperKeysResponse200ItemLtiRegistration):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tool_configuration = GetDeveloperKeysResponse200ItemToolConfiguration.from_dict(d.pop("tool_configuration"))

        public_jwk = GetDeveloperKeysResponse200ItemPublicJwk.from_dict(d.pop("public_jwk"))

        public_jwk_url = d.pop("public_jwk_url")

        lti_registration = GetDeveloperKeysResponse200ItemLtiRegistration.from_dict(d.pop("lti_registration"))
        ...
        get_developer_keys_response_200_item = cls(
            id=id,
            name=name,
            created_at=created_at,
            updated_at=updated_at,
        ...
        get_developer_keys_response_200_item.additional_properties = d
        return get_developer_keys_response_200_item
