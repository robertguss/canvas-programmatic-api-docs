...
T = TypeVar("T", bound="UpdatePagesDataBody")


@_attrs_define
class UpdatePagesDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_pages_data_body = cls(
            wiki_pagepublish_at=wiki_pagepublish_at,
        )

        update_pages_data_body.additional_properties = d
        return update_pages_data_body
