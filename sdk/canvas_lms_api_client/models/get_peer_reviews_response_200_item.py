...
T = TypeVar("T", bound="GetPeerReviewsResponse200Item")


@_attrs_define
class GetPeerReviewsResponse200Item:
    """
    Attributes:
        assessor_id (int):
        asset_id (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_peer_reviews_response_200_item = cls(
            assessor_id=assessor_id,
            asset_id=asset_id,
            asset_type=asset_type,
            id=id,
        ...
        get_peer_reviews_response_200_item.additional_properties = d
        return get_peer_reviews_response_200_item
