...
T = TypeVar("T", bound="CreateCopyFileResponse200")


@_attrs_define
class CreateCopyFileResponse200:
    """
    Attributes:
        id (int):
        uuid (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_copy_file_response_200 = cls(
            id=id,
            uuid=uuid,
            folder_id=folder_id,
            display_name=display_name,
        ...
        create_copy_file_response_200.additional_properties = d
        return create_copy_file_response_200
