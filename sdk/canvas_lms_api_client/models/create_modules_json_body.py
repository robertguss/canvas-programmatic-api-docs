...
T = TypeVar("T", bound="CreateModulesJsonBody")


@_attrs_define
class CreateModulesJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_modules_json_body = cls(
            modulename=modulename,
            moduleunlock_at=moduleunlock_at,
        )

        create_modules_json_body.additional_properties = d
        return create_modules_json_body
