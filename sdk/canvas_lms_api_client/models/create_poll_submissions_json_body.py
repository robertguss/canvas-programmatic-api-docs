...
T = TypeVar("T", bound="CreatePollSubmissionsJsonBody")


@_attrs_define
class CreatePollSubmissionsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_poll_submissions_json_body = cls(
            poll_submissionspoll_choice_id=poll_submissionspoll_choice_id,
        )

        create_poll_submissions_json_body.additional_properties = d
        return create_poll_submissions_json_body
