...
T = TypeVar("T", bound="CreateRubricAssessmentsDataBody")


@_attrs_define
class CreateRubricAssessmentsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_rubric_assessments_data_body = cls(
            rubric_assessment=rubric_assessment,
        )

        create_rubric_assessments_data_body.additional_properties = d
        return create_rubric_assessments_data_body
