...
T = TypeVar("T", bound="CreateAddUsersDataBody")


@_attrs_define
class CreateAddUsersDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_add_users_data_body = cls(
            receiver_ids=receiver_ids,
        )

        create_add_users_data_body.additional_properties = d
        return create_add_users_data_body
