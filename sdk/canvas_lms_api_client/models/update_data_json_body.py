...
T = TypeVar("T", bound="UpdateDataJsonBody")


@_attrs_define
class UpdateDataJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_data_json_body = cls(
            column_datacontent=column_datacontent,
        )

        update_data_json_body.additional_properties = d
        return update_data_json_body
