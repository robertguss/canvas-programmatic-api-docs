...
if TYPE_CHECKING:
    from ..models.list_groups_response_200_item_permissions import ListGroupsResponse200ItemPermissions
...
class ListGroupsResponse200Item:
    ...
    Attributes:
        ...
        permissions (ListGroupsResponse200ItemPermissions):
        users (None):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        permissions = ListGroupsResponse200ItemPermissions.from_dict(d.pop("permissions"))
