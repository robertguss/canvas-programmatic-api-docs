...
T = TypeVar("T", bound="UpdateFoldersDataBody")


@_attrs_define
class UpdateFoldersDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_folders_data_body = cls(
            lock_at=lock_at,
            unlock_at=unlock_at,
        )

        update_folders_data_body.additional_properties = d
        return update_folders_data_body
