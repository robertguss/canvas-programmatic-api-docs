...
T = TypeVar("T", bound="CreateQuizzesResponse200Item")


@_attrs_define
class CreateQuizzesResponse200Item:
    """
    Attributes:
        id (int):
        title (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_quizzes_response_200_item = cls(
            id=id,
            title=title,
            html_url=html_url,
            mobile_url=mobile_url,
        ...
        create_quizzes_response_200_item.additional_properties = d
        return create_quizzes_response_200_item
