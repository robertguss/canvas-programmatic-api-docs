...
if TYPE_CHECKING:
    from ..models.delete_pages_response_200_block_editor_attributes import DeletePagesResponse200BlockEditorAttributes


T = TypeVar("T", bound="DeletePagesResponse200")


@_attrs_define
class DeletePagesResponse200:
    """
    Attributes:
        page_id (int):
        url (str):
        ...
        editor (str):
        block_editor_attributes (DeletePagesResponse200BlockEditorAttributes):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.delete_pages_response_200_block_editor_attributes import (
        ...
        block_editor_attributes = DeletePagesResponse200BlockEditorAttributes.from_dict(
            d.pop("block_editor_attributes")
        )

        delete_pages_response_200 = cls(
            page_id=page_id,
            url=url,
            title=title,
            created_at=created_at,
        ...
        delete_pages_response_200.additional_properties = d
        return delete_pages_response_200
