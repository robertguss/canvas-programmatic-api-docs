...
T = TypeVar("T", bound="UpdateLatePolicyJsonBody")


@_attrs_define
class UpdateLatePolicyJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_late_policy_json_body = cls(
        ...
        update_late_policy_json_body.additional_properties = d
        return update_late_policy_json_body
