...
T = TypeVar("T", bound="CreateContentExportsDataBody")


@_attrs_define
class CreateContentExportsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_content_exports_data_body = cls(
            export_type=export_type,
            select=select,
        )

        create_content_exports_data_body.additional_properties = d
        return create_content_exports_data_body
