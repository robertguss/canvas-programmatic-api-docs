...
if TYPE_CHECKING:
    from ..models.names_and_role_memberships_members_item_message_item_httpspurl_imsglobal_orgspeclticlaimcustom import (
        NamesAndRoleMembershipsMembersItemMessageItemHttpspurlImsglobalOrgspeclticlaimcustom,
    )


T = TypeVar("T", bound="NamesAndRoleMembershipsMembersItemMessageItem")


@_attrs_define
class NamesAndRoleMembershipsMembersItemMessageItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        httpspurl_imsglobal_orgspeclticlaimcustom = (
            NamesAndRoleMembershipsMembersItemMessageItemHttpspurlImsglobalOrgspeclticlaimcustom.from_dict(
                d.pop("https://purl.imsglobal.org/spec/lti/claim/custom")
            )
        )

        names_and_role_memberships_members_item_message_item = cls(
        ...
        names_and_role_memberships_members_item_message_item.additional_properties = d
        return names_and_role_memberships_members_item_message_item
