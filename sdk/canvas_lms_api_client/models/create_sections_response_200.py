...
T = TypeVar("T", bound="CreateSectionsResponse200")


@_attrs_define
class CreateSectionsResponse200:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_sections_response_200 = cls(
            id=id,
            name=name,
            sis_section_id=sis_section_id,
            integration_id=integration_id,
        ...
        create_sections_response_200.additional_properties = d
        return create_sections_response_200
