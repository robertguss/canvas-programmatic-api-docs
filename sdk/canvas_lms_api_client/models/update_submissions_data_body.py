...
T = TypeVar("T", bound="UpdateSubmissionsDataBody")


@_attrs_define
class UpdateSubmissionsDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_submissions_data_body = cls(
        ...
        update_submissions_data_body.additional_properties = d
        return update_submissions_data_body
