...
T = TypeVar("T", bound="GetQuizzesResponse200")


@_attrs_define
class GetQuizzesResponse200:
    """
    Attributes:
        id (str):
        title (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_quizzes_response_200.additional_properties = d
        return get_quizzes_response_200
