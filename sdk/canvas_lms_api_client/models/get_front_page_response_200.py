...
if TYPE_CHECKING:
    from ..models.get_front_page_response_200_block_editor_attributes import (
        GetFrontPageResponse200BlockEditorAttributes,
    )


T = TypeVar("T", bound="GetFrontPageResponse200")


@_attrs_define
class GetFrontPageResponse200:
    """
    Attributes:
        page_id (int):
        url (str):
        ...
        editor (str):
        block_editor_attributes (GetFrontPageResponse200BlockEditorAttributes):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        block_editor_attributes = GetFrontPageResponse200BlockEditorAttributes.from_dict(
            d.pop("block_editor_attributes")
        )

        get_front_page_response_200 = cls(
            page_id=page_id,
            url=url,
            title=title,
            created_at=created_at,
        ...
        get_front_page_response_200.additional_properties = d
        return get_front_page_response_200
