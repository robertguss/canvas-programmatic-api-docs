...
T = TypeVar("T", bound="GetCoursesResponse200ItemPermissions")


@_attrs_define
class GetCoursesResponse200ItemPermissions:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_courses_response_200_item_permissions = cls(
            create_discussion_topic=create_discussion_topic,
            create_announcement=create_announcement,
        )

        get_courses_response_200_item_permissions.additional_properties = d
        return get_courses_response_200_item_permissions
