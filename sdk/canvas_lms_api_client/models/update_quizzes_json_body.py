...
T = TypeVar("T", bound="UpdateQuizzesJsonBody")


@_attrs_define
class UpdateQuizzesJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_quizzes_json_body.additional_properties = d
        return update_quizzes_json_body
