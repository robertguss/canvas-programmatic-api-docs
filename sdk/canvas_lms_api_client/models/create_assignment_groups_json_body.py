...
T = TypeVar("T", bound="CreateAssignmentGroupsJsonBody")


@_attrs_define
class CreateAssignmentGroupsJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_assignment_groups_json_body = cls(
            group_weight=group_weight,
            integration_data=integration_data,
        )

        create_assignment_groups_json_body.additional_properties = d
        return create_assignment_groups_json_body
