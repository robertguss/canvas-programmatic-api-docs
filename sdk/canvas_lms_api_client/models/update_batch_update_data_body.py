...
T = TypeVar("T", bound="UpdateBatchUpdateDataBody")


@_attrs_define
class UpdateBatchUpdateDataBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_batch_update_data_body = cls(
        ...
        update_batch_update_data_body.additional_properties = d
        return update_batch_update_data_body
