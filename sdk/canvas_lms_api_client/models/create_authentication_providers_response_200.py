...
T = TypeVar("T", bound="CreateAuthenticationProvidersResponse200")


@_attrs_define
class CreateAuthenticationProvidersResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_authentication_providers_response_200 = cls(
            identifier_format=identifier_format,
            auth_type=auth_type,
            id=id,
            log_out_url=log_out_url,
        ...
        create_authentication_providers_response_200.additional_properties = d
        return create_authentication_providers_response_200
