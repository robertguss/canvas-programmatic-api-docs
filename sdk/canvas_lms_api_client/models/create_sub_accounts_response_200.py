...
T = TypeVar("T", bound="CreateSubAccountsResponse200")


@_attrs_define
class CreateSubAccountsResponse200:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_sub_accounts_response_200 = cls(
            id=id,
            name=name,
            uuid=uuid,
            parent_account_id=parent_account_id,
        ...
        create_sub_accounts_response_200.additional_properties = d
        return create_sub_accounts_response_200
