...
if TYPE_CHECKING:
    from ..models.update_pages_response_200_block_editor_attributes import UpdatePagesResponse200BlockEditorAttributes


T = TypeVar("T", bound="UpdatePagesResponse200")


@_attrs_define
class UpdatePagesResponse200:
    """
    Attributes:
        page_id (int):
        url (str):
        ...
        editor (str):
        block_editor_attributes (UpdatePagesResponse200BlockEditorAttributes):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.update_pages_response_200_block_editor_attributes import (
        ...
        block_editor_attributes = UpdatePagesResponse200BlockEditorAttributes.from_dict(
            d.pop("block_editor_attributes")
        )

        update_pages_response_200 = cls(
            page_id=page_id,
            url=url,
            title=title,
            created_at=created_at,
        ...
        update_pages_response_200.additional_properties = d
        return update_pages_response_200
