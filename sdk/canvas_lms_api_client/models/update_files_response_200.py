...
T = TypeVar("T", bound="UpdateFilesResponse200")


@_attrs_define
class UpdateFilesResponse200:
    """
    Attributes:
        id (int):
        uuid (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_files_response_200.additional_properties = d
        return update_files_response_200
