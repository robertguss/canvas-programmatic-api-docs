...
if TYPE_CHECKING:
    from ..models.create_duplicate_response_200_integration_data import CreateDuplicateResponse200IntegrationData
    from ..models.create_duplicate_response_200_needs_grading_count_by_section_item import (
        CreateDuplicateResponse200NeedsGradingCountBySectionItem,
    )
    from ..models.create_duplicate_response_200_rubric_settings import CreateDuplicateResponse200RubricSettings


T = TypeVar("T", bound="CreateDuplicateResponse200")


@_attrs_define
class CreateDuplicateResponse200:
    """
    Attributes:
        id (int):
        name (str):
        ...
        needs_grading_count_by_section (list['CreateDuplicateResponse200NeedsGradingCountBySectionItem']):
        position (int):
        post_to_sis (bool):
        integration_id (str):
        integration_data (CreateDuplicateResponse200IntegrationData):
        ...
        rubric_settings (CreateDuplicateResponse200RubricSettings):
        rubric (None):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for needs_grading_count_by_section_item_data in _needs_grading_count_by_section:
            needs_grading_count_by_section_item = CreateDuplicateResponse200NeedsGradingCountBySectionItem.from_dict(
        ...
        integration_data = CreateDuplicateResponse200IntegrationData.from_dict(d.pop("integration_data"))
        ...
        rubric_settings = CreateDuplicateResponse200RubricSettings.from_dict(d.pop("rubric_settings"))
        ...
        create_duplicate_response_200 = cls(
            id=id,
            name=name,
            description=description,
            created_at=created_at,
        ...
        create_duplicate_response_200.additional_properties = d
        return create_duplicate_response_200
