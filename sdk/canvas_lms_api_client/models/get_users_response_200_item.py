...
T = TypeVar("T", bound="GetUsersResponse200Item")


@_attrs_define
class GetUsersResponse200Item:
    """
    Attributes:
        id (int):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_users_response_200_item = cls(
            id=id,
            name=name,
            sortable_name=sortable_name,
            last_name=last_name,
        ...
        get_users_response_200_item.additional_properties = d
        return get_users_response_200_item
