...
T = TypeVar("T", bound="DeleteRubricsResponse200")


@_attrs_define
class DeleteRubricsResponse200:
    """
    Attributes:
        id (int):
        title (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_rubrics_response_200 = cls(
            id=id,
            title=title,
            context_id=context_id,
            context_type=context_type,
        ...
        delete_rubrics_response_200.additional_properties = d
        return delete_rubrics_response_200
